...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec8[0] + fRec8[2])) + (fRec10[0] + (1.8508996845035413 * fRec8[1]))) + -1.2569619999999999)))) + -96.711951219512201);
		...
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec19[0] + fRec19[2])) + (fRec21[0] + (1.8508996845035413 * fRec19[1]))) + -1.887332)))) + -124.17786666666666);
		...
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double((((0.92544984225177063 * (fRec24[0] + fRec24[2])) + (fRec48[0] + (1.8508996845035413 * fRec24[1]))) + -2.617753)))) + -153.04618518518518);
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec13[0] + fRec13[2])) + (fRec50[0] + (1.8508996845035413 * fRec13[1]))) + -1.887332)))) + -124.17786666666666);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec2[0] + fRec2[2])) + (fRec51[0] + (1.8508996845035413 * fRec2[1]))) + -1.2569619999999999)))) + -96.711951219512201);
		...
		fRec60[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec61[0] + fRec61[2])) + (fRec63[0] + (1.8508996845035413 * fRec61[1]))) + -1.2569619999999999)))) + -96.711951219512201);
		fRec59[0] = ((0.025000000000000001 * ((fConst4 * fRec60[0]) + (fConst11 * fRec60[1]))) - (fConst12 * fRec59[1]));
		...
		fRec71[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec72[0] + fRec72[2])) + (fRec74[0] + (1.8508996845035413 * fRec72[1]))) + -1.887332)))) + -124.17786666666666);
		...
		fRec76[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double((((0.92544984225177063 * (fRec77[0] + fRec77[2])) + (fRec100[0] + (1.8508996845035413 * fRec77[1]))) + -2.617753)))) + -153.04618518518518);
		fRec75[0] = ((0.025000000000000001 * ((fConst4 * fRec76[0]) + (fConst11 * fRec76[1]))) - (fConst12 * fRec75[1]));
		...
		fRec65[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec66[0] + fRec66[2])) + (fRec101[0] + (1.8508996845035413 * fRec66[1]))) + -1.887332)))) + -124.17786666666666);
		...
		fRec54[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec55[0] + fRec55[2])) + (fRec102[0] + (1.8508996845035413 * fRec55[1]))) + -1.2569619999999999)))) + -96.711951219512201);
		fRec53[0] = ((0.025000000000000001 * ((fConst4 * fRec54[0]) + (fConst11 * fRec54[1]))) - (fConst12 * fRec53[1]));
