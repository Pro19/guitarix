...
inline void Dsp::clear_state_f()
{
	...
	for (int l50 = 0; (l50 < 3); l50 = (l50 + 1)) fRec59[l50] = 0.0;
	for (int l51 = 0; (l51 < 2); l51 = (l51 + 1)) fVec12[l51] = 0.0;
	for (int l52 = 0; (l52 < 2); l52 = (l52 + 1)) fRec58[l52] = 0.0;
	...
	for (int l62 = 0; (l62 < 3); l62 = (l62 + 1)) fRec60[l62] = 0.0;
	for (int l63 = 0; (l63 < 2); l63 = (l63 + 1)) fRec67[l63] = 0.0;
	...
	for (int l67 = 0; (l67 < 3); l67 = (l67 + 1)) fRec64[l67] = 0.0;
	for (int l68 = 0; (l68 < 2); l68 = (l68 + 1)) fRec69[l68] = 0.0;
	for (int l69 = 0; (l69 < 3); l69 = (l69 + 1)) fRec68[l69] = 0.0;
	for (int l70 = 0; (l70 < 2); l70 = (l70 + 1)) fVec15[l70] = 0.0;
	for (int l71 = 0; (l71 < 2); l71 = (l71 + 1)) fRec52[l71] = 0.0;
	for (int l72 = 0; (l72 < 2); l72 = (l72 + 1)) fVec16[l72] = 0.0;
	for (int l73 = 0; (l73 < 2); l73 = (l73 + 1)) fRec51[l73] = 0.0;
	for (int l74 = 0; (l74 < 3); l74 = (l74 + 1)) fRec50[l74] = 0.0;
	for (int l75 = 0; (l75 < 2); l75 = (l75 + 1)) fVec17[l75] = 0.0;
	for (int l76 = 0; (l76 < 2); l76 = (l76 + 1)) fRec70[l76] = 0.0;
	for (int l77 = 0; (l77 < 2); l77 = (l77 + 1)) fRec49[l77] = 0.0;
	for (int l78 = 0; (l78 < 2); l78 = (l78 + 1)) fRec48[l78] = 0.0;
	for (int l79 = 0; (l79 < 2); l79 = (l79 + 1)) fVec18[l79] = 0.0;
	for (int l80 = 0; (l80 < 2); l80 = (l80 + 1)) fRec47[l80] = 0.0;
	for (int l81 = 0; (l81 < 2); l81 = (l81 + 1)) fVec19[l81] = 0.0;
	for (int l82 = 0; (l82 < 2); l82 = (l82 + 1)) fRec46[l82] = 0.0;
	for (int l83 = 0; (l83 < 3); l83 = (l83 + 1)) fRec45[l83] = 0.0;
	for (int l84 = 0; (l84 < 2); l84 = (l84 + 1)) fVec20[l84] = 0.0;
	for (int l85 = 0; (l85 < 2); l85 = (l85 + 1)) fRec71[l85] = 0.0;
	for (int l86 = 0; (l86 < 2); l86 = (l86 + 1)) fRec44[l86] = 0.0;
	for (int l87 = 0; (l87 < 2); l87 = (l87 + 1)) fRec43[l87] = 0.0;
	for (int l88 = 0; (l88 < 2); l88 = (l88 + 1)) fVec21[l88] = 0.0;
	for (int l89 = 0; (l89 < 2); l89 = (l89 + 1)) fRec42[l89] = 0.0;
	for (int l90 = 0; (l90 < 2); l90 = (l90 + 1)) fVec22[l90] = 0.0;
	for (int l91 = 0; (l91 < 2); l91 = (l91 + 1)) fRec41[l91] = 0.0;
	for (int l92 = 0; (l92 < 3); l92 = (l92 + 1)) fRec40[l92] = 0.0;
	for (int l93 = 0; (l93 < 2); l93 = (l93 + 1)) fVec23[l93] = 0.0;
	for (int l94 = 0; (l94 < 2); l94 = (l94 + 1)) fRec72[l94] = 0.0;
	for (int l95 = 0; (l95 < 2); l95 = (l95 + 1)) fRec39[l95] = 0.0;
	for (int l96 = 0; (l96 < 2); l96 = (l96 + 1)) fRec38[l96] = 0.0;
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec13[0] + fRec13[2])) + (fRec34[0] + (1.8508996845035413 * fRec13[1]))) + -3.7189619999999999)))) + -112.26066666666668);
		fRec11[0] = ((0.025000000000000001 * ((fConst4 * fRec12[0]) + (fConst26 * fRec12[1]))) - (fConst27 * fRec11[1]));
		double fTemp18 = (fRec11[0] * fRec5[0]);
		fVec6[0] = fTemp18;
		fRec10[0] = (fConst6 * ((2.0 * (fTemp18 + fVec6[1])) - (fConst7 * fRec10[1])));
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec8[0] + fRec8[2])) + (fRec35[0] + (1.8508996845035413 * fRec8[1]))) + -2.3148439999999999)))) + -95.677066666666661);
		fRec6[0] = ((0.025000000000000001 * ((fConst4 * fRec7[0]) + (fConst26 * fRec7[1]))) - (fConst27 * fRec6[1]));
		double fTemp21 = (fRec5[0] * fRec6[0]);
		fVec9[0] = fTemp21;
		fRec4[0] = (fConst6 * ((2.0 * (fTemp21 + fVec9[1])) - (fConst7 * fRec4[1])));
		...
		fVec11[0] = fTemp23;
		fRec36[0] = (0.0 - (fConst66 * ((fConst67 * fRec36[1]) - (fTemp23 + fVec11[1]))));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec2[0] + fRec2[2])) + (fRec36[0] + (1.8508996845035413 * fRec2[1]))) + -1.3565670000000001)))) + -84.564999999999998);
		fRec0[0] = ((0.025000000000000001 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		fRec37[0] = (fSlow11 + (0.999 * fRec37[1]));
		output0[i] = FAUSTFLOAT((2.0 * (fRec0[0] * fRec37[0])));
		double fTemp24 = double(input1[i]);
		double fTemp25 = (fRec23[0] * fTemp24);
		fRec59[0] = (fTemp25 + (1.0000000000000001e-15 - (fConst23 * ((fConst24 * fRec59[2]) + (fConst25 * fRec59[1])))));
		double fTemp26 = (fRec59[2] + (fRec59[0] + (2.0 * fRec59[1])));
		fVec12[0] = fTemp26;
		fRec58[0] = ((fConst23 * ((fConst4 * fTemp26) + (fConst26 * fVec12[1]))) - (fConst27 * fRec58[1]));
		fRec57[0] = (0.0 - (fConst19 * ((fConst20 * fRec57[1]) - (fRec58[0] + fRec58[1]))));
		fRec56[0] = (fRec57[0] - (fConst15 * ((fConst28 * fRec56[2]) + (fConst31 * fRec56[1]))));
		double fTemp27 = (fRec56[2] + (fRec56[0] + (2.0 * fRec56[1])));
		fVec13[0] = fTemp27;
		fRec55[0] = ((fConst15 * ((fConst17 * fTemp27) + (fConst32 * fVec13[1]))) - (fConst34 * fRec55[1]));
		fRec54[0] = (fRec55[0] - (fConst10 * ((fConst35 * fRec54[2]) + (fConst36 * fRec54[1]))));
		double fTemp28 = (fConst46 * fRec53[1]);
		fRec53[0] = ((fConst10 * (((fConst12 * fRec54[0]) + (fConst37 * fRec54[1])) + (fConst12 * fRec54[2]))) - (fConst41 * ((fConst43 * fRec53[2]) + fTemp28)));
		double fTemp29 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow4 * (fRec53[2] + (fConst41 * (fTemp28 + (fConst43 * fRec53[0])))))));
		fRec63[0] = ((fConst47 * fRec58[1]) - (fConst19 * ((fConst20 * fRec63[1]) - (fConst14 * fRec58[0]))));
		fRec62[0] = (fRec63[0] - (fConst15 * ((fConst28 * fRec62[2]) + (fConst31 * fRec62[1]))));
		double fTemp30 = (fConst36 * fRec61[1]);
		fRec61[0] = ((fConst15 * (((fConst30 * fRec62[0]) + (fConst48 * fRec62[1])) + (fConst30 * fRec62[2]))) - (fConst49 * ((fConst50 * fRec61[2]) + fTemp30)));
		double fTemp31 = (fConst46 * fRec60[1]);
		fRec60[0] = ((fRec61[2] + (fConst49 * (fTemp30 + (fConst50 * fRec61[0])))) - (fConst41 * ((fConst43 * fRec60[2]) + fTemp31)));
		double fTemp32 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec60[2] + (fConst41 * (fTemp31 + (fConst43 * fRec60[0])))))));
		fRec67[0] = (0.0 - (fConst53 * ((fConst33 * fRec67[1]) - (fConst15 * (fTemp27 + fVec13[1])))));
		fRec66[0] = (fRec67[0] - (fConst10 * ((fConst35 * fRec66[2]) + (fConst36 * fRec66[1]))));
		double fTemp33 = (fRec66[2] + (fRec66[0] + (2.0 * fRec66[1])));
		fVec14[0] = fTemp33;
		fRec65[0] = ((fConst10 * ((fConst52 * fTemp33) + (fConst54 * fVec14[1]))) - (fConst55 * fRec65[1]));
		fRec64[0] = (fRec65[0] - (fConst51 * ((fConst56 * fRec64[2]) + (fConst46 * fRec64[1]))));
		double fTemp34 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst45 * fRec64[0]) + (fConst57 * fRec64[1])) + (fConst45 * fRec64[2])))));
		fRec69[0] = (0.0 - (fConst58 * ((fConst42 * fRec69[1]) - (fConst10 * (fTemp33 + fVec14[1])))));
		fRec68[0] = (fRec69[0] - (fConst51 * ((fConst56 * fRec68[2]) + (fConst46 * fRec68[1]))));
		double fTemp35 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec68[2] + (fRec68[0] + (2.0 * fRec68[1]))))));
		...
		fVec15[0] = fTemp36;
		fRec52[0] = (0.0 - (fConst6 * ((fConst7 * fRec52[1]) - (fTemp36 + fVec15[1]))));
		double fTemp37 = (fTemp13 * fTemp24);
		double fTemp38 = (fTemp37 + 1.0000000000000001e-15);
		double fTemp39 = (((fSlow3 * fRec52[0]) + ((fTemp37 + (fSlow9 * ((4.0 * (fTemp38 * (1.0 - std::fabs(fTemp38)))) + (-1.0000000000000001e-15 - fTemp37)))) + (fSlow10 * (fTemp25 + 1.0000000000000001e-15)))) + 2.0000000000000002e-15);
		fVec16[0] = fTemp39;
		fRec51[0] = ((0.93028479253239138 * (fTemp39 + fVec16[1])) - (0.86056958506478287 * fRec51[1]));
		fRec50[0] = (fRec51[0] - ((1.8405051250752198 * fRec50[1]) + (0.86129424393186271 * fRec50[2])));
		double fTemp40 = ((0.027 * fRec49[1]) + 1.0000000000000001e-15);
		fVec17[0] = fTemp40;
		fRec70[0] = (0.0 - (fConst60 * ((fConst61 * fRec70[1]) - (fTemp40 + fVec17[1]))));
		fRec49[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec50[0] + fRec50[2])) + (fRec70[0] + (1.8508996845035413 * fRec50[1]))) + -3.7189619999999999)))) + -112.26066666666668);
		fRec48[0] = ((0.025000000000000001 * ((fConst4 * fRec49[0]) + (fConst26 * fRec49[1]))) - (fConst27 * fRec48[1]));
		double fTemp41 = (fRec5[0] * fRec48[0]);
		fVec18[0] = fTemp41;
		fRec47[0] = (fConst6 * ((2.0 * (fTemp41 + fVec18[1])) - (fConst7 * fRec47[1])));
		double fTemp42 = (fRec47[0] + 1.0000000000000001e-15);
		fVec19[0] = fTemp42;
		fRec46[0] = ((0.93028479253239138 * (fTemp42 + fVec19[1])) - (0.86056958506478287 * fRec46[1]));
		fRec45[0] = (fRec46[0] - ((1.8405051250752198 * fRec45[1]) + (0.86129424393186271 * fRec45[2])));
		double fTemp43 = ((0.014999999999999999 * fRec44[1]) + 1.0000000000000001e-15);
		fVec20[0] = fTemp43;
		fRec71[0] = (0.0 - (fConst63 * ((fConst64 * fRec71[1]) - (fTemp43 + fVec20[1]))));
		fRec44[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec45[0] + fRec45[2])) + (fRec71[0] + (1.8508996845035413 * fRec45[1]))) + -2.3148439999999999)))) + -95.677066666666661);
		fRec43[0] = ((0.025000000000000001 * ((fConst4 * fRec44[0]) + (fConst26 * fRec44[1]))) - (fConst27 * fRec43[1]));
		double fTemp44 = (fRec5[0] * fRec43[0]);
		fVec21[0] = fTemp44;
		fRec42[0] = (fConst6 * ((2.0 * (fTemp44 + fVec21[1])) - (fConst7 * fRec42[1])));
		double fTemp45 = (fRec42[0] + 1.0000000000000001e-15);
		fVec22[0] = fTemp45;
		fRec41[0] = ((0.93028479253239138 * (fTemp45 + fVec22[1])) - (0.86056958506478287 * fRec41[1]));
		fRec40[0] = (fRec41[0] - ((1.8405051250752198 * fRec40[1]) + (0.86129424393186271 * fRec40[2])));
		double fTemp46 = ((0.0082000000000000007 * fRec39[1]) + 1.0000000000000001e-15);
		fVec23[0] = fTemp46;
		fRec72[0] = (0.0 - (fConst66 * ((fConst67 * fRec72[1]) - (fTemp46 + fVec23[1]))));
		fRec39[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec40[0] + fRec40[2])) + (fRec72[0] + (1.8508996845035413 * fRec40[1]))) + -1.3565670000000001)))) + -84.564999999999998);
		fRec38[0] = ((0.025000000000000001 * ((fConst4 * fRec39[0]) + (fConst26 * fRec39[1]))) - (fConst27 * fRec38[1]));
		output1[i] = FAUSTFLOAT((2.0 * (fRec37[0] * fRec38[0])));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
