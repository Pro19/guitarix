// generated from file '../src/LV2/faust/tonestack_fender_default_stereo.dsp' by dsp2cc:
// Code generated with Faust (https://faust.grame.fr)


namespace tonestack_fender_default_stereo {
...
#define fVslider2 (*fVslider2_)
	...
	double fSlow2 = ((0.00047000000000000004 * fSlow0) + (0.025062500000000001 * fSlow1));
	double fSlow3 = (fConst0 * (fSlow2 + 0.015765000000000001));
	double fSlow4 = (4.7117500000000004e-07 * fSlow0);
	double fSlow5 = ((((((1.1779375000000001e-05 * fSlow1) + -4.1994500000000009e-06) - fSlow4) * fSlow0) + (0.00011998125000000002 * fSlow1)) + 5.718000000000001e-06);
	double fSlow6 = ((1.0281250000000001e-09 * fSlow1) - (4.1125e-11 * fSlow0));
	double fSlow7 = (7.3437500000000008e-09 * fSlow1);
	double fSlow8 = ((((fSlow6 + -2.5262499999999999e-10) * fSlow0) + fSlow7) + 2.9374999999999999e-10);
	double fSlow9 = (fConst0 * fSlow8);
	double fSlow10 = (1.0 / (-1.0 - (fSlow3 + (fConst1 * (fSlow5 + fSlow9)))));
	double fSlow11 = double(fVslider2);
	double fSlow12 = (fConst0 * ((fSlow2 + (6.2500000000000001e-05 * fSlow11)) + 0.0010024999999999999));
	double fSlow13 = (((9.187500000000001e-07 * fSlow11) + (((5.0055000000000002e-07 - fSlow4) * fSlow0) + (fSlow1 * ((1.1779375000000001e-05 * fSlow0) + 2.4812500000000002e-06)))) + 9.9250000000000005e-08);
	double fSlow14 = (((fSlow6 + 4.1125e-11) * fSlow0) + ((fSlow7 - (2.9374999999999999e-10 * (fSlow0 + -1.0))) * fSlow11));
...
} // end namespace tonestack_fender_default_stereo
