...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst28 = (0.0 - (1.0 / (fConst27 * fConst22)));
...
#define fVslider4 (*fVslider4_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp8 = (1.0 - fRec14[0]);
		int iTemp9 = int(std::min<double>(131072.0, std::max<double>(0.0, fRec15[0])));
		int iTemp10 = int(std::min<double>(131072.0, std::max<double>(0.0, fRec16[0])));
		fRec2[0] = (fTemp6 + (fRec12[0] * ((fTemp8 * fVec1[((IOTA - iTemp9) & 262143)]) + (fRec14[0] * fVec1[((IOTA - iTemp10) & 262143)]))));
		...
		fRec27[0] = (0.0 - (fConst29 * ((fConst30 * fRec27[1]) - (fVec0[1] + fTemp0))));
		...
		fRec18[0] = (fTemp16 + (fRec12[0] * ((fTemp8 * fVec3[((IOTA - iTemp9) & 262143)]) + (fRec14[0] * fVec3[((IOTA - iTemp10) & 262143)]))));
		fRec17[0] = (fRec18[0] - (fConst65 * fRec17[1]));
		double fTemp17 = (fConst3 * ((fConst5 * fRec17[0]) + (fConst4 * fRec17[1])));
		...
		double fTemp18 = (fRec36[2] + (fRec36[0] + (2.0 * fRec36[1])));
		fVec4[0] = fTemp18;
		fRec35[0] = ((fConst66 * ((fConst73 * fTemp18) + (fConst75 * fVec4[1]))) - (fConst76 * fRec35[1]));
		fRec34[0] = (fRec35[0] - (fConst72 * ((fConst77 * fRec34[2]) + (fConst51 * fRec34[1]))));
		double fTemp19 = (fConst60 * fRec33[1]);
		fRec33[0] = ((fConst72 * (((fConst50 * fRec34[0]) + (fConst78 * fRec34[1])) + (fConst50 * fRec34[2]))) - (fConst55 * ((fConst57 * fRec33[2]) + fTemp19)));
		fRec32[0] = ((fRec33[2] + (fConst55 * (fTemp19 + (fConst57 * fRec33[0])))) - (fConst61 * fRec32[1]));
		double fTemp20 = (fConst21 * ((fRec32[0] * fTemp4) + (0.00069742843622086102 * (fRec11[0] * fRec32[1]))));
		double fTemp21 = ((fConst8 * (fRec30[2] + (fRec30[0] + (2.0 * fRec30[1])))) + (int(signbit(double(fTemp20)))?double(input12ax7_negclip(double(fTemp20))):double(input12ax7clip(double(fTemp20)))));
		fVec5[(IOTA & 262143)] = fTemp21;
		fRec29[0] = (fTemp21 + (fRec12[0] * ((fTemp8 * fVec5[((IOTA - iTemp9) & 262143)]) + (fRec14[0] * fVec5[((IOTA - iTemp10) & 262143)]))));
		fRec28[0] = (fRec29[0] - (fConst65 * fRec28[1]));
		double fTemp22 = (fConst3 * ((fConst5 * fRec28[0]) + (fConst4 * fRec28[1])));
		...
		fRec46[0] = (0.0 - (fConst81 * ((fConst47 * fRec46[1]) - (fConst66 * (fTemp18 + fVec4[1])))));
		fRec45[0] = (fRec46[0] - (fConst72 * ((fConst77 * fRec45[2]) + (fConst51 * fRec45[1]))));
		double fTemp23 = (fRec45[2] + (fRec45[0] + (2.0 * fRec45[1])));
		fVec6[0] = fTemp23;
		fRec44[0] = ((fConst72 * ((fConst80 * fTemp23) + (fConst82 * fVec6[1]))) - (fConst83 * fRec44[1]));
		...
		double fTemp24 = (fConst21 * ((fRec42[0] * fTemp4) + (0.00069742843622086102 * (fRec11[0] * fRec42[1]))));
		double fTemp25 = ((fConst8 * (fRec40[2] + (fRec40[0] + (2.0 * fRec40[1])))) + (int(signbit(double(fTemp24)))?double(input12ax7_negclip(double(fTemp24))):double(input12ax7clip(double(fTemp24)))));
		fVec7[(IOTA & 262143)] = fTemp25;
		fRec39[0] = (fTemp25 + (fRec12[0] * ((fTemp8 * fVec7[((IOTA - iTemp9) & 262143)]) + (fRec14[0] * fVec7[((IOTA - iTemp10) & 262143)]))));
		fRec38[0] = (fRec39[0] - (fConst65 * fRec38[1]));
		double fTemp26 = (fConst3 * ((fConst5 * fRec38[0]) + (fConst4 * fRec38[1])));
		...
		fRec53[0] = (0.0 - (fConst86 * ((fConst56 * fRec53[1]) - (fConst72 * (fTemp23 + fVec6[1])))));
		...
		double fTemp27 = (fConst21 * ((fRec51[0] * fTemp4) + (0.00069742843622086102 * (fRec11[0] * fRec51[1]))));
		double fTemp28 = ((fConst8 * (fRec49[2] + (fRec49[0] + (2.0 * fRec49[1])))) + (int(signbit(double(fTemp27)))?double(input12ax7_negclip(double(fTemp27))):double(input12ax7clip(double(fTemp27)))));
		fVec8[(IOTA & 262143)] = fTemp28;
		fRec48[0] = (fTemp28 + (fRec12[0] * ((fTemp8 * fVec8[((IOTA - iTemp9) & 262143)]) + (fRec14[0] * fVec8[((IOTA - iTemp10) & 262143)]))));
		fRec47[0] = (fRec48[0] - (fConst65 * fRec47[1]));
		double fTemp29 = (fConst3 * ((fConst5 * fRec47[0]) + (fConst4 * fRec47[1])));
		output0[i] = FAUSTFLOAT((fRec0[0] * (((((int(signbit(double(fTemp11)))?double(output12ax7_negclip(double(fTemp11))):double(output12ax7clip(double(fTemp11)))) + (int(signbit(double(fTemp17)))?double(output12ax7_negclip(double(fTemp17))):double(output12ax7clip(double(fTemp17))))) + (int(signbit(double(fTemp22)))?double(output12ax7_negclip(double(fTemp22))):double(output12ax7clip(double(fTemp22))))) + (int(signbit(double(fTemp26)))?double(output12ax7_negclip(double(fTemp26))):double(output12ax7clip(double(fTemp26))))) + (int(signbit(double(fTemp29)))?double(output12ax7_negclip(double(fTemp29))):double(output12ax7clip(double(fTemp29)))))));
		fRec0[1] = fRec0[0];
		fRec4[2] = fRec4[1];
		fRec4[1] = fRec4[0];
		fRec3[2] = fRec3[1];
