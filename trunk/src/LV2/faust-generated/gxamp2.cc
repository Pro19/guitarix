...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp13 = ((1.0 - fRec24[0]) * fTemp0);
		double fTemp14 = (fTemp13 + 1.0000000000000001e-15);
		double fTemp15 = ((fRec10[0] * (((fSlow3 * fRec16[0]) + ((fTemp13 + (fSlow9 * ((4.0 * (fTemp14 * (1.0 - std::fabs(fTemp14)))) + (-1.0000000000000001e-15 - fTemp13)))) + (fSlow10 * (fTemp1 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15)) + 1.0000000000000001e-15);
		fVec4[0] = fTemp15;
		...
		double fTemp16 = ((0.027 * fRec13[1]) + 1.0000000000000001e-15);
		fVec5[0] = fTemp16;
		fRec35[0] = (0.0 - (fConst60 * ((fConst61 * fRec35[1]) - (fTemp16 + fVec5[1]))));
		...
		double fTemp17 = ((fRec10[0] * fRec11[0]) + 1.0000000000000001e-15);
		fVec6[0] = fTemp17;
		fRec9[0] = ((0.93028479253239138 * (fTemp17 + fVec6[1])) - (0.86056958506478287 * fRec9[1]));
		fRec8[0] = (fRec9[0] - ((1.8405051250752198 * fRec8[1]) + (0.86129424393186271 * fRec8[2])));
		double fTemp18 = ((0.014999999999999999 * fRec7[1]) + 1.0000000000000001e-15);
		fVec7[0] = fTemp18;
		fRec36[0] = (0.0 - (fConst63 * ((fConst64 * fRec36[1]) - (fTemp18 + fVec7[1]))));
		...
		double fTemp19 = (fRec4[0] + (1.0000000000000001e-15 - (1.0589999999999999 * fRec4[1])));
		fVec8[0] = fTemp19;
		fRec3[0] = ((0.93028479253239138 * (fTemp19 + fVec8[1])) - (0.86056958506478287 * fRec3[1]));
		fRec2[0] = (fRec3[0] - ((1.8405051250752198 * fRec2[1]) + (0.86129424393186271 * fRec2[2])));
		double fTemp20 = ((0.0082000000000000007 * fRec1[1]) + 1.0000000000000001e-15);
		fVec9[0] = fTemp20;
		fRec38[0] = (0.0 - (fConst68 * ((fConst69 * fRec38[1]) - (fTemp20 + fVec9[1]))));
