...
#define fVslider2 (*fVslider2_)
	...
	double fSlow3 = (fConst0 * (fSlow2 + 0.0031515000000000002));
	double fSlow4 = (3.0937500000000006e-07 * fSlow0);
	double fSlow5 = ((((((1.2375000000000003e-05 * fSlow1) + -2.99475e-07) - fSlow4) * fSlow0) + (3.1086000000000007e-05 * fSlow1)) + 1.0851500000000001e-06);
	double fSlow6 = ((1.8513000000000002e-09 * fSlow1) - (4.6282500000000009e-11 * fSlow0));
	double fSlow7 = (3.3880000000000003e-09 * fSlow1);
	double fSlow8 = ((((fSlow6 + -3.8417500000000006e-11) * fSlow0) + fSlow7) + 8.4700000000000015e-11);
	...
	double fSlow13 = (((3.0800000000000001e-07 * fSlow11) + (((3.7812500000000009e-07 - fSlow4) * fSlow0) + (fSlow1 * ((1.2375000000000003e-05 * fSlow0) + 3.9820000000000002e-06)))) + 9.9550000000000015e-08);
	double fSlow14 = (((fSlow6 + 4.6282500000000009e-11) * fSlow0) + ((fSlow7 - (8.4700000000000015e-11 * (fSlow0 + -1.0))) * fSlow11));
