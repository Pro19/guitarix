...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec69[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec70[0] + fRec70[2])) + (fRec72[0] + (1.8508996845035413 * fRec70[1]))) + -1.8639460000000001)))) + -60.964962962962957);
		...
		fRec64[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec65[0] + fRec65[2])) + (fRec73[0] + (1.8508996845035413 * fRec65[1]))) + -1.271609)))) + -45.226066666666668);
		fRec63[0] = ((0.050000000000000003 * ((fConst4 * fRec64[0]) + (fConst27 * fRec64[1]))) - (fConst28 * fRec63[1]));
		...
		fRec60[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec61[0] + fRec61[2])) + (fRec74[0] + (1.8508996845035413 * fRec61[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		fRec59[0] = ((0.050000000000000003 * ((fConst4 * fRec60[0]) + (fConst27 * fRec60[1]))) - (fConst28 * fRec59[1]));
