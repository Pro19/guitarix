...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_6C16_68k), double((((0.92544984225177063 * (fRec13[0] + fRec13[2])) + (fRec34[0] + (1.8508996845035413 * fRec13[1]))) + -2.9218060000000001)))) + -141.78496296296294);
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double((((0.92544984225177063 * (fRec8[0] + fRec8[2])) + (fRec35[0] + (1.8508996845035413 * fRec8[1]))) + -2.0977429999999999)))) + -110.15046666666666);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double((((0.92544984225177063 * (fRec2[0] + fRec2[2])) + (fRec36[0] + (1.8508996845035413 * fRec2[1]))) + -1.3787419999999999)))) + -81.860731707317086);
		...
		fRec49[0] = (double(Ftube(int(TUBE_TABLE_6C16_68k), double((((0.92544984225177063 * (fRec50[0] + fRec50[2])) + (fRec70[0] + (1.8508996845035413 * fRec50[1]))) + -2.9218060000000001)))) + -141.78496296296294);
		fRec48[0] = ((0.025000000000000001 * ((fConst4 * fRec49[0]) + (fConst26 * fRec49[1]))) - (fConst27 * fRec48[1]));
		double fTemp41 = (fRec5[0] * fRec48[0]);
		fVec18[0] = fTemp41;
		fRec47[0] = (0.0 - (fConst6 * ((fConst7 * fRec47[1]) - (fTemp41 + fVec18[1]))));
		...
		fRec44[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double((((0.92544984225177063 * (fRec45[0] + fRec45[2])) + (fRec71[0] + (1.8508996845035413 * fRec45[1]))) + -2.0977429999999999)))) + -110.15046666666666);
		fRec43[0] = ((0.025000000000000001 * ((fConst4 * fRec44[0]) + (fConst26 * fRec44[1]))) - (fConst27 * fRec43[1]));
		double fTemp44 = (fRec5[0] * fRec43[0]);
		fVec21[0] = fTemp44;
		fRec42[0] = (0.0 - (fConst6 * ((fConst7 * fRec42[1]) - (fTemp44 + fVec21[1]))));
		...
		fRec39[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double((((0.92544984225177063 * (fRec40[0] + fRec40[2])) + (fRec72[0] + (1.8508996845035413 * fRec40[1]))) + -1.3787419999999999)))) + -81.860731707317086);
		fRec38[0] = ((0.025000000000000001 * ((fConst4 * fRec39[0]) + (fConst26 * fRec39[1]))) - (fConst27 * fRec38[1]));
		output1[i] = FAUSTFLOAT((fRec37[0] * fRec38[0]));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
