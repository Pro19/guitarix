...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst2 = (8.9068910724842994e-15 * fConst0);
	fConst3 = (((((fConst2 + 6.4917759212794798e-12) * fConst0) + 2.5100665591164499e-10) * fConst0) + 2.4697044736012902e-09);
	fConst4 = (fConst1 / fConst3);
	fConst5 = (9.0138480164185596e-13 * fConst0);
	fConst6 = (fConst5 + 1.6298631366961702e-11);
	fConst7 = (4.3359066716033201e-10 * fConst0);
	fConst8 = (((fConst7 + 2.0976223579538801e-08) * fConst0) + 2.44130776766847e-07);
	fConst9 = (fConst0 / fConst8);
	fConst10 = (2.5486049432641702e-08 * fConst0);
	...
	fConst18 = (0.0 - (1.0 / (fConst17 * fConst12)));
	...
	fConst33 = std::tan((659.73445725385659 / fConst0));
	...
	fConst42 = std::tan((270.1769682087222 / fConst0));
	fConst43 = (1.0 / fConst42);
	fConst44 = (fConst43 + 1.0);
	fConst45 = (1.0 / ((fConst44 / fConst42) + 1.0));
	fConst46 = (1.0 - fConst43);
	fConst47 = (1.0 - (fConst46 / fConst42));
	fConst48 = mydsp_faustpower2_f(fConst42);
	fConst49 = (1.0 / fConst48);
	fConst50 = (2.0 * (1.0 - fConst49));
	fConst51 = (1.99975590383756e-19 * fConst0);
	fConst52 = (((-6.0498368275157696e-16 - fConst51) * fConst1) + 1.3013842919715099e-11);
	fConst53 = (1.9997559038375601e-18 * fConst0);
	fConst54 = (((-1.05044706792186e-15 - fConst53) * fConst1) + 6.19273198244244e-13);
	fConst55 = (1.9334301783374702e-18 * fConst0);
	fConst56 = ((fConst55 + 9.9148601709850608e-16) * fConst1);
	...
	fConst60 = (((6.0498368275157696e-16 - fConst51) * fConst1) + -1.3013842919715099e-11);
	fConst61 = (((1.05044706792186e-15 - fConst53) * fConst1) + -6.19273198244244e-13);
	fConst62 = ((fConst55 + -9.9148601709850608e-16) * fConst1);
	fConst63 = (4.9993897595939102e-20 * fConst0);
	fConst64 = (((((fConst63 + -3.0249184137578799e-16) * fConst0) + 1.4018644245068199e-13) * fConst0) + -6.50692145985754e-12);
	fConst65 = (4.9993897595939098e-19 * fConst0);
	fConst66 = (((((fConst65 + -5.2522353396092803e-16) * fConst0) + 2.5594194600659201e-14) * fConst0) + -3.09636599122122e-13);
	fConst67 = (4.8335754458436803e-19 * fConst0);
	fConst68 = ((((4.9574300854925304e-16 - fConst67) * fConst0) + -1.23854639648849e-14) * fConst0);
	fConst69 = (((((fConst63 + 3.0249184137578799e-16) * fConst0) + 1.4018644245068199e-13) * fConst0) + 6.50692145985754e-12);
	fConst70 = (((((fConst65 + 5.2522353396092803e-16) * fConst0) + 2.5594194600659201e-14) * fConst0) + 3.09636599122122e-13);
	fConst71 = ((((-4.9574300854925304e-16 - fConst67) * fConst0) + -1.23854639648849e-14) * fConst0);
	fConst72 = (2.8419671458380501e-18 * fConst0);
	fConst73 = (((((-2.8798600411158901e-15 - fConst72) * fConst0) + -7.1428107598729697e-12) * fConst0) + -9.4732238194602296e-11);
	fConst74 = (1.42098357291903e-14 * fConst0);
	fConst75 = ((-1.89464476389205e-13 - fConst74) * fConst0);
	fConst76 = (1.1367868583352201e-17 * fConst0);
	fConst77 = (((fConst76 + 5.7597200822317897e-15) * fConst1) + -1.8946447638920501e-10);
	fConst78 = (2.84196714583805e-14 * fConst1);
	fConst79 = (1.4285621519745901e-11 - (1.7051802875028302e-17 * fConst1));
	fConst80 = (((fConst76 + -5.7597200822317897e-15) * fConst1) + 1.8946447638920501e-10);
	fConst81 = (((((2.8798600411158901e-15 - fConst72) * fConst0) + -7.1428107598729697e-12) * fConst0) + 9.4732238194602296e-11);
	fConst82 = ((fConst74 + -1.89464476389205e-13) * fConst0);
	fConst83 = (1.0 / fConst8);
	fConst84 = (4.8826155353369304e-07 - (8.6718133432066401e-10 * fConst1));
	fConst85 = (((fConst7 + -2.0976223579538801e-08) * fConst0) + 2.44130776766847e-07);
	fConst86 = (5.0972098865283297e-08 * fConst0);
	fConst87 = (3.39813992435224e-07 - fConst10);
	fConst88 = (1.0 / fConst3);
	fConst89 = (2.6720673217452901e-14 * fConst0);
	fConst90 = (((((-6.4917759212794798e-12 - fConst89) * fConst0) + 2.5100665591164499e-10) * fConst0) + 7.4091134208038597e-09);
	fConst91 = (((((fConst89 + -6.4917759212794798e-12) * fConst0) + -2.5100665591164499e-10) * fConst0) + 7.4091134208038597e-09);
	fConst92 = (((((6.4917759212794798e-12 - fConst2) * fConst0) + -2.5100665591164499e-10) * fConst0) + 2.4697044736012902e-09);
	fConst93 = (2.7041544049255698e-12 * fConst0);
...
#define fVslider2 (*fVslider2_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec2[0] = ((int(signbit(double(fTemp14)))?double(bigchumppre_negclip(double(fTemp14))):double(bigchumppreclip(double(fTemp14)))) - (fConst83 * ((fConst84 * fRec2[1]) + (fConst85 * fRec2[2]))));
		double fTemp15 = (fConst9 * (((fConst11 * fRec2[0]) + (fConst86 * fRec2[1])) + (fConst87 * fRec2[2])));
		fRec1[0] = ((int(signbit(double(fTemp15)))?double(bigchumppre2_negclip(double(fTemp15))):double(bigchumppre2clip(double(fTemp15)))) - (fConst88 * (((fConst90 * fRec1[1]) + (fConst91 * fRec1[2])) + (fConst92 * fRec1[3]))));
		double fTemp16 = (fConst4 * ((((fConst6 * fRec1[0]) + (fConst94 * fRec1[1])) + (fConst95 * fRec1[2])) + (fConst96 * fRec1[3])));
		fRec19[0] = (0.0 - (fConst19 * ((fConst20 * fRec19[1]) - (fVec0[1] + fTemp0))));
		...
		fRec12[0] = ((int(signbit(double(fTemp21)))?double(bigchumppre_negclip(double(fTemp21))):double(bigchumppreclip(double(fTemp21)))) - (fConst83 * ((fConst84 * fRec12[1]) + (fConst85 * fRec12[2]))));
		double fTemp22 = (fConst9 * (((fConst11 * fRec12[0]) + (fConst86 * fRec12[1])) + (fConst87 * fRec12[2])));
		fRec11[0] = ((int(signbit(double(fTemp22)))?double(bigchumppre2_negclip(double(fTemp22))):double(bigchumppre2clip(double(fTemp22)))) - (fConst88 * (((fConst90 * fRec11[1]) + (fConst91 * fRec11[2])) + (fConst92 * fRec11[3]))));
		...
		fRec21[0] = ((int(signbit(double(fTemp26)))?double(bigchumppre_negclip(double(fTemp26))):double(bigchumppreclip(double(fTemp26)))) - (fConst83 * ((fConst84 * fRec21[1]) + (fConst85 * fRec21[2]))));
		double fTemp27 = (fConst9 * (((fConst11 * fRec21[0]) + (fConst86 * fRec21[1])) + (fConst87 * fRec21[2])));
		fRec20[0] = ((int(signbit(double(fTemp27)))?double(bigchumppre2_negclip(double(fTemp27))):double(bigchumppre2clip(double(fTemp27)))) - (fConst88 * (((fConst90 * fRec20[1]) + (fConst91 * fRec20[2])) + (fConst92 * fRec20[3]))));
		...
		fRec29[0] = ((int(signbit(double(fTemp30)))?double(bigchumppre_negclip(double(fTemp30))):double(bigchumppreclip(double(fTemp30)))) - (fConst83 * ((fConst84 * fRec29[1]) + (fConst85 * fRec29[2]))));
		double fTemp31 = (fConst9 * (((fConst11 * fRec29[0]) + (fConst86 * fRec29[1])) + (fConst87 * fRec29[2])));
		fRec28[0] = ((int(signbit(double(fTemp31)))?double(bigchumppre2_negclip(double(fTemp31))):double(bigchumppre2clip(double(fTemp31)))) - (fConst88 * (((fConst90 * fRec28[1]) + (fConst91 * fRec28[2])) + (fConst92 * fRec28[3]))));
		...
		fRec36[0] = ((int(signbit(double(fTemp33)))?double(bigchumppre_negclip(double(fTemp33))):double(bigchumppreclip(double(fTemp33)))) - (fConst83 * ((fConst84 * fRec36[1]) + (fConst85 * fRec36[2]))));
		double fTemp34 = (fConst9 * (((fConst11 * fRec36[0]) + (fConst86 * fRec36[1])) + (fConst87 * fRec36[2])));
		fRec35[0] = ((int(signbit(double(fTemp34)))?double(bigchumppre2_negclip(double(fTemp34))):double(bigchumppre2clip(double(fTemp34)))) - (fConst88 * (((fConst90 * fRec35[1]) + (fConst91 * fRec35[2])) + (fConst92 * fRec35[3]))));
		double fTemp35 = (fConst4 * ((((fConst6 * fRec35[0]) + (fConst94 * fRec35[1])) + (fConst95 * fRec35[2])) + (fConst96 * fRec35[3])));
		output0[i] = FAUSTFLOAT((fRec0[0] * (((((int(signbit(double(fTemp16)))?double(bigchumppower_negclip(double(fTemp16))):double(bigchumppowerclip(double(fTemp16)))) + (int(signbit(double(fTemp23)))?double(bigchumppower_negclip(double(fTemp23))):double(bigchumppowerclip(double(fTemp23))))) + (int(signbit(double(fTemp28)))?double(bigchumppower_negclip(double(fTemp28))):double(bigchumppowerclip(double(fTemp28))))) + (int(signbit(double(fTemp32)))?double(bigchumppower_negclip(double(fTemp32))):double(bigchumppowerclip(double(fTemp32))))) + (int(signbit(double(fTemp35)))?double(bigchumppower_negclip(double(fTemp35))):double(bigchumppowerclip(double(fTemp35)))))));
		fRec0[1] = fRec0[0];
		fRec3[1] = fRec3[0];
		fVec0[1] = fVec0[0];
		fRec9[1] = fRec9[0];
