...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec60[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec61[0] + fRec61[2])) + (fRec63[0] + (1.8508996845035413 * fRec61[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		fRec59[0] = ((0.050000000000000003 * ((fConst4 * fRec60[0]) + (fConst11 * fRec60[1]))) - (fConst12 * fRec59[1]));
		...
		fRec71[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec72[0] + fRec72[2])) + (fRec74[0] + (1.8508996845035413 * fRec72[1]))) + -1.271609)))) + -45.226066666666668);
		fRec70[0] = ((0.050000000000000003 * ((fConst4 * fRec71[0]) + (fConst11 * fRec71[1]))) - (fConst12 * fRec70[1]));
		...
		fRec76[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec77[0] + fRec77[2])) + (fRec100[0] + (1.8508996845035413 * fRec77[1]))) + -1.8639460000000001)))) + -60.964962962962957);
		fRec75[0] = ((0.050000000000000003 * ((fConst4 * fRec76[0]) + (fConst11 * fRec76[1]))) - (fConst12 * fRec75[1]));
		...
		fRec65[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec66[0] + fRec66[2])) + (fRec101[0] + (1.8508996845035413 * fRec66[1]))) + -1.271609)))) + -45.226066666666668);
		fRec64[0] = ((0.050000000000000003 * ((fConst4 * fRec65[0]) + (fConst11 * fRec65[1]))) - (fConst12 * fRec64[1]));
		...
		fRec54[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec55[0] + fRec55[2])) + (fRec102[0] + (1.8508996845035413 * fRec55[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		fRec53[0] = ((0.050000000000000003 * ((fConst4 * fRec54[0]) + (fConst11 * fRec54[1]))) - (fConst12 * fRec53[1]));
