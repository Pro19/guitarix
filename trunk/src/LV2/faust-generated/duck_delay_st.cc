...
void Dsp::connect(uint32_t port,void* data)
{
	...
	{
	case AMOUNT: 
		fHslider0_ = (float*)data; // , 0.5, 0.0, 56.0, 0.050000000000000003 
		break;
	case ATTACK: 
		fHslider1_ = (float*)data; // , 0.10000000000000001, 0.050000000000000003, 0.5, 0.050000000000000003 
		break;
	case COLORATION: 
		fHslider7_ = (float*)data; // , 0.0, -1.0, 1.0, 0.050000000000000003 
		break;
	case EFFECT: 
		fHslider3_ = (float*)data; // , 0.0, -16.0, 4.0, 0.10000000000000001 
		break;
	case FEEDBACK: 
		fHslider4_ = (float*)data; // , 0.0, 0.0, 1.0, 0.050000000000000003 
		break;
	case PINGPONG: 
		fHslider5_ = (float*)data; // , 0.0, 0.0, 1.0, 0.050000000000000003 
		break;
	case RELEASE: 
		fHslider2_ = (float*)data; // , 0.10000000000000001, 0.050000000000000003, 2.0, 0.050000000000000003 
		break;
	case TIME: 
		fHslider6_ = (float*)data; // , 500.0, 1.0, 2000.0, 1.0 
		break;
	default:
		break;
	}
