...
#define fVslider0 (*fVslider0_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		fRec3[0] = (double(buf[i]) - (fConst10 * ((fConst14 * fRec3[1]) + (fConst15 * fRec3[2]))));
		...
		buf[i] = FAUSTFLOAT((fConst3 * ((fRec0[2] * (0.0 - (7.0334369593045297e-06 * fRec6[0]))) + (7.0334369593045297e-06 * (fRec0[0] * fRec6[0])))));
		fRec3[2] = fRec3[1];
		fRec3[1] = fRec3[0];
		fVec0[1] = fVec0[0];
		fRec5[1] = fRec5[0];
