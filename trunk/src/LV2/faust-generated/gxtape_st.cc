...
inline void Dsp::clear_state_f()
{
	...
	for (int l215 = 0; (l215 < 2); l215 = (l215 + 1)) fRec190[l215] = 0.0;
	for (int l216 = 0; (l216 < 3); l216 = (l216 + 1)) fRec189[l216] = 0.0;
	for (int l217 = 0; (l217 < 3); l217 = (l217 + 1)) fRec188[l217] = 0.0;
	for (int l218 = 0; (l218 < 3); l218 = (l218 + 1)) fRec187[l218] = 0.0;
	for (int l219 = 0; (l219 < 3); l219 = (l219 + 1)) fRec186[l219] = 0.0;
	for (int l220 = 0; (l220 < 2); l220 = (l220 + 1)) fRec185[l220] = 0.0;
	for (int l221 = 0; (l221 < 2); l221 = (l221 + 1)) fVec32[l221] = 0.0;
	for (int l222 = 0; (l222 < 2); l222 = (l222 + 1)) fRec201[l222] = 0.0;
	for (int l223 = 0; (l223 < 2); l223 = (l223 + 1)) fRec200[l223] = 0.0;
	for (int l224 = 0; (l224 < 2); l224 = (l224 + 1)) fRec199[l224] = 0.0;
	for (int l225 = 0; (l225 < 2); l225 = (l225 + 1)) fRec198[l225] = 0.0;
	for (int l226 = 0; (l226 < 3); l226 = (l226 + 1)) fRec197[l226] = 0.0;
	for (int l227 = 0; (l227 < 2); l227 = (l227 + 1)) fVec33[l227] = 0.0;
	for (int l228 = 0; (l228 < 2); l228 = (l228 + 1)) fRec196[l228] = 0.0;
	for (int l229 = 0; (l229 < 2); l229 = (l229 + 1)) fRec195[l229] = 0.0;
	for (int l230 = 0; (l230 < 3); l230 = (l230 + 1)) fRec194[l230] = 0.0;
	for (int l231 = 0; (l231 < 2); l231 = (l231 + 1)) fVec34[l231] = 0.0;
	for (int l232 = 0; (l232 < 2); l232 = (l232 + 1)) fRec193[l232] = 0.0;
	for (int l233 = 0; (l233 < 3); l233 = (l233 + 1)) fRec192[l233] = 0.0;
	for (int l234 = 0; (l234 < 2); l234 = (l234 + 1)) fRec203[l234] = 0.0;
	for (int l235 = 0; (l235 < 3); l235 = (l235 + 1)) fRec202[l235] = 0.0;
	for (int l236 = 0; (l236 < 2); l236 = (l236 + 1)) fRec208[l236] = 0.0;
	for (int l237 = 0; (l237 < 3); l237 = (l237 + 1)) fRec207[l237] = 0.0;
	for (int l238 = 0; (l238 < 2); l238 = (l238 + 1)) fRec209[l238] = 0.0;
	for (int l239 = 0; (l239 < 3); l239 = (l239 + 1)) fRec206[l239] = 0.0;
	for (int l240 = 0; (l240 < 3); l240 = (l240 + 1)) fRec205[l240] = 0.0;
	for (int l241 = 0; (l241 < 3); l241 = (l241 + 1)) fRec204[l241] = 0.0;
	for (int l242 = 0; (l242 < 3); l242 = (l242 + 1)) fRec213[l242] = 0.0;
	for (int l243 = 0; (l243 < 2); l243 = (l243 + 1)) fRec214[l243] = 0.0;
	for (int l244 = 0; (l244 < 3); l244 = (l244 + 1)) fRec212[l244] = 0.0;
	for (int l245 = 0; (l245 < 3); l245 = (l245 + 1)) fRec211[l245] = 0.0;
	for (int l246 = 0; (l246 < 3); l246 = (l246 + 1)) fRec210[l246] = 0.0;
	for (int l247 = 0; (l247 < 8192); l247 = (l247 + 1)) fVec35[l247] = 0.0;
	for (int l248 = 0; (l248 < 8192); l248 = (l248 + 1)) fVec36[l248] = 0.0;
	for (int l249 = 0; (l249 < 2); l249 = (l249 + 1)) fRec215[l249] = 0.0;
	for (int l250 = 0; (l250 < 3); l250 = (l250 + 1)) fRec191[l250] = 0.0;
	for (int l251 = 0; (l251 < 2); l251 = (l251 + 1)) fRec184[l251] = 0.0;
	for (int l252 = 0; (l252 < 3); l252 = (l252 + 1)) fRec183[l252] = 0.0;
	for (int l253 = 0; (l253 < 2); l253 = (l253 + 1)) fRec224[l253] = 0.0;
	for (int l254 = 0; (l254 < 3); l254 = (l254 + 1)) fRec223[l254] = 0.0;
	for (int l255 = 0; (l255 < 2); l255 = (l255 + 1)) fVec37[l255] = 0.0;
	for (int l256 = 0; (l256 < 2); l256 = (l256 + 1)) fRec222[l256] = 0.0;
	for (int l257 = 0; (l257 < 3); l257 = (l257 + 1)) fRec221[l257] = 0.0;
	for (int l258 = 0; (l258 < 3); l258 = (l258 + 1)) fRec220[l258] = 0.0;
	for (int l259 = 0; (l259 < 3); l259 = (l259 + 1)) fRec219[l259] = 0.0;
	for (int l260 = 0; (l260 < 2); l260 = (l260 + 1)) fRec218[l260] = 0.0;
	for (int l261 = 0; (l261 < 2); l261 = (l261 + 1)) fVec38[l261] = 0.0;
	for (int l262 = 0; (l262 < 2); l262 = (l262 + 1)) fRec235[l262] = 0.0;
	for (int l263 = 0; (l263 < 2); l263 = (l263 + 1)) fRec234[l263] = 0.0;
	for (int l264 = 0; (l264 < 2); l264 = (l264 + 1)) fRec233[l264] = 0.0;
	for (int l265 = 0; (l265 < 2); l265 = (l265 + 1)) fRec232[l265] = 0.0;
	for (int l266 = 0; (l266 < 3); l266 = (l266 + 1)) fRec231[l266] = 0.0;
	for (int l267 = 0; (l267 < 2); l267 = (l267 + 1)) fVec39[l267] = 0.0;
	for (int l268 = 0; (l268 < 2); l268 = (l268 + 1)) fRec230[l268] = 0.0;
	for (int l269 = 0; (l269 < 2); l269 = (l269 + 1)) fRec229[l269] = 0.0;
	for (int l270 = 0; (l270 < 3); l270 = (l270 + 1)) fRec228[l270] = 0.0;
	for (int l271 = 0; (l271 < 2); l271 = (l271 + 1)) fVec40[l271] = 0.0;
	for (int l272 = 0; (l272 < 2); l272 = (l272 + 1)) fRec227[l272] = 0.0;
	for (int l273 = 0; (l273 < 3); l273 = (l273 + 1)) fRec226[l273] = 0.0;
	for (int l274 = 0; (l274 < 2); l274 = (l274 + 1)) fRec237[l274] = 0.0;
	for (int l275 = 0; (l275 < 3); l275 = (l275 + 1)) fRec236[l275] = 0.0;
	for (int l276 = 0; (l276 < 2); l276 = (l276 + 1)) fRec242[l276] = 0.0;
	for (int l277 = 0; (l277 < 3); l277 = (l277 + 1)) fRec241[l277] = 0.0;
	for (int l278 = 0; (l278 < 2); l278 = (l278 + 1)) fRec243[l278] = 0.0;
	for (int l279 = 0; (l279 < 3); l279 = (l279 + 1)) fRec240[l279] = 0.0;
	for (int l280 = 0; (l280 < 3); l280 = (l280 + 1)) fRec239[l280] = 0.0;
	for (int l281 = 0; (l281 < 3); l281 = (l281 + 1)) fRec238[l281] = 0.0;
	for (int l282 = 0; (l282 < 3); l282 = (l282 + 1)) fRec247[l282] = 0.0;
	for (int l283 = 0; (l283 < 2); l283 = (l283 + 1)) fRec248[l283] = 0.0;
	for (int l284 = 0; (l284 < 3); l284 = (l284 + 1)) fRec246[l284] = 0.0;
	for (int l285 = 0; (l285 < 3); l285 = (l285 + 1)) fRec245[l285] = 0.0;
	for (int l286 = 0; (l286 < 3); l286 = (l286 + 1)) fRec244[l286] = 0.0;
	for (int l287 = 0; (l287 < 8192); l287 = (l287 + 1)) fVec41[l287] = 0.0;
	for (int l288 = 0; (l288 < 8192); l288 = (l288 + 1)) fVec42[l288] = 0.0;
	for (int l289 = 0; (l289 < 2); l289 = (l289 + 1)) fRec249[l289] = 0.0;
	for (int l290 = 0; (l290 < 3); l290 = (l290 + 1)) fRec225[l290] = 0.0;
	for (int l291 = 0; (l291 < 2); l291 = (l291 + 1)) fRec217[l291] = 0.0;
	for (int l292 = 0; (l292 < 3); l292 = (l292 + 1)) fRec216[l292] = 0.0;
	...
	for (int l301 = 0; (l301 < 2); l301 = (l301 + 1)) fRec268[l301] = 0.0;
	for (int l302 = 0; (l302 < 2); l302 = (l302 + 1)) fRec267[l302] = 0.0;
	for (int l303 = 0; (l303 < 2); l303 = (l303 + 1)) fRec266[l303] = 0.0;
	for (int l304 = 0; (l304 < 2); l304 = (l304 + 1)) fRec265[l304] = 0.0;
	for (int l305 = 0; (l305 < 3); l305 = (l305 + 1)) fRec264[l305] = 0.0;
	for (int l306 = 0; (l306 < 2); l306 = (l306 + 1)) fVec45[l306] = 0.0;
	for (int l307 = 0; (l307 < 2); l307 = (l307 + 1)) fRec263[l307] = 0.0;
	for (int l308 = 0; (l308 < 2); l308 = (l308 + 1)) fRec262[l308] = 0.0;
	for (int l309 = 0; (l309 < 3); l309 = (l309 + 1)) fRec261[l309] = 0.0;
	for (int l310 = 0; (l310 < 2); l310 = (l310 + 1)) fVec46[l310] = 0.0;
	for (int l311 = 0; (l311 < 2); l311 = (l311 + 1)) fRec260[l311] = 0.0;
	for (int l312 = 0; (l312 < 3); l312 = (l312 + 1)) fRec259[l312] = 0.0;
	for (int l313 = 0; (l313 < 2); l313 = (l313 + 1)) fRec270[l313] = 0.0;
	for (int l314 = 0; (l314 < 3); l314 = (l314 + 1)) fRec269[l314] = 0.0;
	for (int l315 = 0; (l315 < 2); l315 = (l315 + 1)) fRec275[l315] = 0.0;
	for (int l316 = 0; (l316 < 3); l316 = (l316 + 1)) fRec274[l316] = 0.0;
	for (int l317 = 0; (l317 < 2); l317 = (l317 + 1)) fRec276[l317] = 0.0;
	for (int l318 = 0; (l318 < 3); l318 = (l318 + 1)) fRec273[l318] = 0.0;
	for (int l319 = 0; (l319 < 3); l319 = (l319 + 1)) fRec272[l319] = 0.0;
	for (int l320 = 0; (l320 < 3); l320 = (l320 + 1)) fRec271[l320] = 0.0;
	for (int l321 = 0; (l321 < 3); l321 = (l321 + 1)) fRec280[l321] = 0.0;
	for (int l322 = 0; (l322 < 2); l322 = (l322 + 1)) fRec281[l322] = 0.0;
	for (int l323 = 0; (l323 < 3); l323 = (l323 + 1)) fRec279[l323] = 0.0;
	for (int l324 = 0; (l324 < 3); l324 = (l324 + 1)) fRec278[l324] = 0.0;
	for (int l325 = 0; (l325 < 3); l325 = (l325 + 1)) fRec277[l325] = 0.0;
	for (int l326 = 0; (l326 < 8192); l326 = (l326 + 1)) fVec47[l326] = 0.0;
	for (int l327 = 0; (l327 < 8192); l327 = (l327 + 1)) fVec48[l327] = 0.0;
	for (int l328 = 0; (l328 < 2); l328 = (l328 + 1)) fRec282[l328] = 0.0;
	...
	for (int l339 = 0; (l339 < 2); l339 = (l339 + 1)) fRec300[l339] = 0.0;
	for (int l340 = 0; (l340 < 2); l340 = (l340 + 1)) fRec299[l340] = 0.0;
	for (int l341 = 0; (l341 < 2); l341 = (l341 + 1)) fRec298[l341] = 0.0;
	for (int l342 = 0; (l342 < 2); l342 = (l342 + 1)) fRec297[l342] = 0.0;
	for (int l343 = 0; (l343 < 3); l343 = (l343 + 1)) fRec296[l343] = 0.0;
	for (int l344 = 0; (l344 < 2); l344 = (l344 + 1)) fVec51[l344] = 0.0;
	for (int l345 = 0; (l345 < 2); l345 = (l345 + 1)) fRec295[l345] = 0.0;
	for (int l346 = 0; (l346 < 2); l346 = (l346 + 1)) fRec294[l346] = 0.0;
	for (int l347 = 0; (l347 < 3); l347 = (l347 + 1)) fRec293[l347] = 0.0;
	for (int l348 = 0; (l348 < 2); l348 = (l348 + 1)) fVec52[l348] = 0.0;
	for (int l349 = 0; (l349 < 2); l349 = (l349 + 1)) fRec292[l349] = 0.0;
	for (int l350 = 0; (l350 < 3); l350 = (l350 + 1)) fRec291[l350] = 0.0;
	for (int l351 = 0; (l351 < 2); l351 = (l351 + 1)) fRec302[l351] = 0.0;
	for (int l352 = 0; (l352 < 3); l352 = (l352 + 1)) fRec301[l352] = 0.0;
	for (int l353 = 0; (l353 < 2); l353 = (l353 + 1)) fRec307[l353] = 0.0;
	for (int l354 = 0; (l354 < 3); l354 = (l354 + 1)) fRec306[l354] = 0.0;
	for (int l355 = 0; (l355 < 2); l355 = (l355 + 1)) fRec308[l355] = 0.0;
	for (int l356 = 0; (l356 < 3); l356 = (l356 + 1)) fRec305[l356] = 0.0;
	for (int l357 = 0; (l357 < 3); l357 = (l357 + 1)) fRec304[l357] = 0.0;
	for (int l358 = 0; (l358 < 3); l358 = (l358 + 1)) fRec303[l358] = 0.0;
	for (int l359 = 0; (l359 < 3); l359 = (l359 + 1)) fRec312[l359] = 0.0;
	for (int l360 = 0; (l360 < 2); l360 = (l360 + 1)) fRec313[l360] = 0.0;
	for (int l361 = 0; (l361 < 3); l361 = (l361 + 1)) fRec311[l361] = 0.0;
	for (int l362 = 0; (l362 < 3); l362 = (l362 + 1)) fRec310[l362] = 0.0;
	for (int l363 = 0; (l363 < 3); l363 = (l363 + 1)) fRec309[l363] = 0.0;
	for (int l364 = 0; (l364 < 8192); l364 = (l364 + 1)) fVec53[l364] = 0.0;
	for (int l365 = 0; (l365 < 8192); l365 = (l365 + 1)) fVec54[l365] = 0.0;
	for (int l366 = 0; (l366 < 2); l366 = (l366 + 1)) fRec314[l366] = 0.0;
	...
	for (int l374 = 0; (l374 < 2); l374 = (l374 + 1)) fRec330[l374] = 0.0;
	for (int l375 = 0; (l375 < 2); l375 = (l375 + 1)) fRec329[l375] = 0.0;
	for (int l376 = 0; (l376 < 2); l376 = (l376 + 1)) fRec328[l376] = 0.0;
	for (int l377 = 0; (l377 < 2); l377 = (l377 + 1)) fRec327[l377] = 0.0;
	for (int l378 = 0; (l378 < 3); l378 = (l378 + 1)) fRec326[l378] = 0.0;
	for (int l379 = 0; (l379 < 2); l379 = (l379 + 1)) fVec56[l379] = 0.0;
	for (int l380 = 0; (l380 < 2); l380 = (l380 + 1)) fRec325[l380] = 0.0;
	for (int l381 = 0; (l381 < 2); l381 = (l381 + 1)) fRec324[l381] = 0.0;
	for (int l382 = 0; (l382 < 3); l382 = (l382 + 1)) fRec323[l382] = 0.0;
	for (int l383 = 0; (l383 < 2); l383 = (l383 + 1)) fVec57[l383] = 0.0;
	for (int l384 = 0; (l384 < 2); l384 = (l384 + 1)) fRec322[l384] = 0.0;
	for (int l385 = 0; (l385 < 3); l385 = (l385 + 1)) fRec321[l385] = 0.0;
	for (int l386 = 0; (l386 < 2); l386 = (l386 + 1)) fRec332[l386] = 0.0;
	for (int l387 = 0; (l387 < 3); l387 = (l387 + 1)) fRec331[l387] = 0.0;
	for (int l388 = 0; (l388 < 2); l388 = (l388 + 1)) fRec337[l388] = 0.0;
	for (int l389 = 0; (l389 < 3); l389 = (l389 + 1)) fRec336[l389] = 0.0;
	for (int l390 = 0; (l390 < 2); l390 = (l390 + 1)) fRec338[l390] = 0.0;
	for (int l391 = 0; (l391 < 3); l391 = (l391 + 1)) fRec335[l391] = 0.0;
	for (int l392 = 0; (l392 < 3); l392 = (l392 + 1)) fRec334[l392] = 0.0;
	for (int l393 = 0; (l393 < 3); l393 = (l393 + 1)) fRec333[l393] = 0.0;
	for (int l394 = 0; (l394 < 3); l394 = (l394 + 1)) fRec342[l394] = 0.0;
	for (int l395 = 0; (l395 < 2); l395 = (l395 + 1)) fRec343[l395] = 0.0;
	for (int l396 = 0; (l396 < 3); l396 = (l396 + 1)) fRec341[l396] = 0.0;
	for (int l397 = 0; (l397 < 3); l397 = (l397 + 1)) fRec340[l397] = 0.0;
	for (int l398 = 0; (l398 < 3); l398 = (l398 + 1)) fRec339[l398] = 0.0;
	for (int l399 = 0; (l399 < 8192); l399 = (l399 + 1)) fVec58[l399] = 0.0;
	for (int l400 = 0; (l400 < 8192); l400 = (l400 + 1)) fVec59[l400] = 0.0;
	for (int l401 = 0; (l401 < 2); l401 = (l401 + 1)) fRec344[l401] = 0.0;
...
void Dsp::mem_alloc()
{
	...
	if (!fVec35) fVec35 = new double[8192];
...
void Dsp::mem_free()
{
	...
	if (fVec35) { delete fVec35; fVec35 = 0; }
...
#define fVslider7 (*fVslider7_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fVec31[0] = fTemp76;
		fRec190[0] = ((fConst16 * fVec31[1]) - (fConst17 * ((fConst18 * fRec190[1]) - (fConst11 * fTemp76))));
		fRec189[0] = (fRec190[0] - (fConst12 * ((fConst19 * fRec189[2]) + (fConst20 * fRec189[1]))));
		double fTemp77 = (fConst30 * fRec188[1]);
		fRec188[0] = ((fConst12 * (((fConst14 * fRec189[0]) + (fConst21 * fRec189[1])) + (fConst14 * fRec189[2]))) - (fConst25 * ((fConst27 * fRec188[2]) + fTemp77)));
		double fTemp78 = (fConst39 * fRec187[1]);
		fRec187[0] = ((fRec188[2] + (fConst25 * (fTemp77 + (fConst27 * fRec188[0])))) - (fConst34 * ((fConst36 * fRec187[2]) + fTemp78)));
		double fTemp79 = (fConst48 * fRec186[1]);
		fRec186[0] = ((fRec187[2] + (fConst34 * (fTemp78 + (fConst36 * fRec187[0])))) - (fConst43 * ((fConst45 * fRec186[2]) + fTemp79)));
		fRec185[0] = ((fRec186[2] + (fConst43 * (fTemp79 + (fConst45 * fRec186[0])))) - (fConst49 * fRec185[1]));
		double fTemp80 = (fConst9 * ((fRec185[0] * fTemp4) + (0.00027518994799636398 * (fRec8[0] * fRec185[1]))));
		double fTemp81 = (int(signbit(double(fTemp80)))?double(input12au7_negclip(double(fTemp80))):double(input12au7clip(double(fTemp80))));
		fVec32[0] = fTemp81;
		fRec201[0] = (0.0 - (((fSlow10 * fRec201[1]) - (fTemp81 + fVec32[1])) / fSlow11));
		fRec200[0] = (fRec201[0] - (0.29999999999999999 * fRec200[1]));
		fRec199[0] = (((2.0 / (std::exp((0.0 - (5.0 * fRec200[0]))) + 1.0)) + (0.29999999999999999 * fRec199[1])) + -1.0);
		fRec198[0] = (0.0 - (fConst73 * ((fConst74 * fRec198[1]) - (fRec199[0] + fRec199[1]))));
		fRec197[0] = (fRec198[0] - (fConst72 * ((fConst76 * fRec197[2]) + (fConst77 * fRec197[1]))));
		double fTemp82 = (fRec197[2] + (fRec197[0] + (2.0 * fRec197[1])));
		fVec33[0] = fTemp82;
		fRec196[0] = ((fConst72 * ((fConst70 * fTemp82) + (fConst71 * fVec33[1]))) - (fConst79 * fRec196[1]));
		fRec195[0] = ((fConst71 * fRec196[1]) - (fConst80 * ((fConst78 * fRec195[1]) - (fConst68 * fRec196[0]))));
		double fTemp83 = (fConst66 * fRec194[1]);
		fRec194[0] = (fRec195[0] - (fConst65 * ((fConst81 * fRec194[2]) + fTemp83)));
		double fTemp84 = ((fTemp83 + (fConst83 * fRec194[0])) + (fConst84 * fRec194[2]));
		fVec34[0] = fTemp84;
		fRec193[0] = (0.0 - (fConst59 * ((fConst60 * fRec193[1]) - (fConst65 * (fTemp84 + fVec34[1])))));
		fRec192[0] = (fRec193[0] - (fConst56 * ((fConst85 * fRec192[2]) + (fConst77 * fRec192[1]))));
		fRec203[0] = (0.0 - (fConst89 * ((fConst90 * fRec203[1]) - (fRec195[0] + fRec195[1]))));
		fRec202[0] = (fRec203[0] - (fConst86 * ((fConst91 * fRec202[2]) + (fConst92 * fRec202[1]))));
		fRec208[0] = ((fConst104 * fRec196[1]) - (fConst105 * ((fConst106 * fRec208[1]) - (fConst102 * fRec196[0]))));
		double fTemp85 = (fConst100 * fRec207[1]);
		fRec207[0] = (fRec208[0] - (fConst99 * ((fConst107 * fRec207[2]) + fTemp85)));
		fRec209[0] = (0.0 - (fConst112 * ((fConst113 * fRec209[1]) - (fRec206[1] + fRec206[2]))));
		fRec206[0] = ((fConst99 * ((fTemp85 + (fConst109 * fRec207[0])) + (fConst110 * fRec207[2]))) - fRec209[0]);
		fRec205[0] = (fRec206[0] - (fConst94 * ((fConst114 * fRec205[2]) + (fConst77 * fRec205[1]))));
		fRec204[0] = ((fConst94 * (fRec205[2] + (fRec205[0] + (2.0 * fRec205[1])))) - (fConst93 * ((fConst115 * fRec204[2]) + (fConst77 * fRec204[1]))));
		double fTemp86 = (fConst100 * fRec213[1]);
		fRec213[0] = (fRec195[0] - (fConst99 * ((fConst107 * fRec213[2]) + fTemp86)));
		fRec214[0] = (0.0 - (fConst112 * ((fConst113 * fRec214[1]) - (fRec212[1] + fRec212[2]))));
		fRec212[0] = ((fConst99 * ((fTemp86 + (fConst109 * fRec213[0])) + (fConst110 * fRec213[2]))) - fRec214[0]);
		fRec211[0] = (fRec212[0] - (fConst117 * ((fConst118 * fRec211[2]) + (fConst119 * fRec211[1]))));
		fRec210[0] = ((fConst117 * (fRec211[2] + (fRec211[0] + (2.0 * fRec211[1])))) - (fConst116 * ((fConst120 * fRec210[2]) + (fConst119 * fRec210[1]))));
		double fTemp87 = (fTemp20 + (iSlow6?(iSlow8?(fConst116 * (fRec210[2] + (fRec210[0] + (2.0 * fRec210[1])))):(fConst93 * (fRec204[2] + (fRec204[0] + (2.0 * fRec204[1]))))):(iSlow8?(fConst86 * (fRec202[2] + (fRec202[0] + (2.0 * fRec202[1])))):(fConst56 * (fRec192[2] + (fRec192[0] + (2.0 * fRec192[1])))))));
		fVec35[(IOTA & 8191)] = fTemp87;
		double fTemp88 = ((fTemp13 * fVec35[((IOTA - iTemp22) & 8191)]) + (fRec18[0] * fVec35[((IOTA - iTemp23) & 8191)]));
		fVec36[(IOTA & 8191)] = fTemp88;
		fRec215[0] = (0.0 - (((fSlow10 * fRec215[1]) - (fRec191[1] + fRec191[2])) / fSlow11));
		fRec191[0] = (((fTemp10 * fVec36[((IOTA - iTemp25) & 8191)]) + (fRec11[0] * fVec36[((IOTA - iTemp26) & 8191)])) - fRec215[0]);
		fRec184[0] = ((iSlow0?fRec191[0]:fTemp81) - (fConst131 * fRec184[1]));
		double fTemp89 = (fConst6 * ((fTemp27 * fRec184[1]) + (0.00025707707823962699 * (fRec184[0] * fTemp28))));
		fRec183[0] = ((int(signbit(double(fTemp89)))?double(output12au7_negclip(double(fTemp89))):double(output12au7clip(double(fTemp89)))) - (fConst3 * ((fConst132 * fRec183[2]) + (fConst133 * fRec183[1]))));
		fRec224[0] = (0.0 - (fConst17 * ((fConst18 * fRec224[1]) - (fVec31[1] + fTemp76))));
		fRec223[0] = (fRec224[0] - (fConst12 * ((fConst19 * fRec223[2]) + (fConst20 * fRec223[1]))));
		double fTemp90 = (fRec223[2] + (fRec223[0] + (2.0 * fRec223[1])));
		fVec37[0] = fTemp90;
		fRec222[0] = ((fConst12 * ((fConst135 * fTemp90) + (fConst136 * fVec37[1]))) - (fConst137 * fRec222[1]));
		fRec221[0] = (fRec222[0] - (fConst134 * ((fConst138 * fRec221[2]) + (fConst30 * fRec221[1]))));
		double fTemp91 = (fConst39 * fRec220[1]);
		fRec220[0] = ((fConst134 * (((fConst29 * fRec221[0]) + (fConst139 * fRec221[1])) + (fConst29 * fRec221[2]))) - (fConst34 * ((fConst36 * fRec220[2]) + fTemp91)));
		double fTemp92 = (fConst48 * fRec219[1]);
		fRec219[0] = ((fRec220[2] + (fConst34 * (fTemp91 + (fConst36 * fRec220[0])))) - (fConst43 * ((fConst45 * fRec219[2]) + fTemp92)));
		fRec218[0] = ((fRec219[2] + (fConst43 * (fTemp92 + (fConst45 * fRec219[0])))) - (fConst49 * fRec218[1]));
		double fTemp93 = (fConst9 * ((fRec218[0] * fTemp4) + (0.00027518994799636398 * (fRec8[0] * fRec218[1]))));
		double fTemp94 = (int(signbit(double(fTemp93)))?double(input12au7_negclip(double(fTemp93))):double(input12au7clip(double(fTemp93))));
		fVec38[0] = fTemp94;
		fRec235[0] = (0.0 - (((fSlow10 * fRec235[1]) - (fTemp94 + fVec38[1])) / fSlow11));
		fRec234[0] = (fRec235[0] - (0.29999999999999999 * fRec234[1]));
		fRec233[0] = (((2.0 / (std::exp((0.0 - (5.0 * fRec234[0]))) + 1.0)) + (0.29999999999999999 * fRec233[1])) + -1.0);
		fRec232[0] = (0.0 - (fConst73 * ((fConst74 * fRec232[1]) - (fRec233[0] + fRec233[1]))));
		fRec231[0] = (fRec232[0] - (fConst72 * ((fConst76 * fRec231[2]) + (fConst77 * fRec231[1]))));
		double fTemp95 = (fRec231[2] + (fRec231[0] + (2.0 * fRec231[1])));
		fVec39[0] = fTemp95;
		fRec230[0] = ((fConst72 * ((fConst70 * fTemp95) + (fConst71 * fVec39[1]))) - (fConst79 * fRec230[1]));
		fRec229[0] = ((fConst71 * fRec230[1]) - (fConst80 * ((fConst78 * fRec229[1]) - (fConst68 * fRec230[0]))));
		double fTemp96 = (fConst66 * fRec228[1]);
		fRec228[0] = (fRec229[0] - (fConst65 * ((fConst81 * fRec228[2]) + fTemp96)));
		double fTemp97 = ((fTemp96 + (fConst83 * fRec228[0])) + (fConst84 * fRec228[2]));
		fVec40[0] = fTemp97;
		fRec227[0] = (0.0 - (fConst59 * ((fConst60 * fRec227[1]) - (fConst65 * (fTemp97 + fVec40[1])))));
		fRec226[0] = (fRec227[0] - (fConst56 * ((fConst85 * fRec226[2]) + (fConst77 * fRec226[1]))));
		fRec237[0] = (0.0 - (fConst89 * ((fConst90 * fRec237[1]) - (fRec229[0] + fRec229[1]))));
		fRec236[0] = (fRec237[0] - (fConst86 * ((fConst91 * fRec236[2]) + (fConst92 * fRec236[1]))));
		fRec242[0] = ((fConst104 * fRec230[1]) - (fConst105 * ((fConst106 * fRec242[1]) - (fConst102 * fRec230[0]))));
		double fTemp98 = (fConst100 * fRec241[1]);
		fRec241[0] = (fRec242[0] - (fConst99 * ((fConst107 * fRec241[2]) + fTemp98)));
		fRec243[0] = (0.0 - (fConst112 * ((fConst113 * fRec243[1]) - (fRec240[1] + fRec240[2]))));
		fRec240[0] = ((fConst99 * ((fTemp98 + (fConst109 * fRec241[0])) + (fConst110 * fRec241[2]))) - fRec243[0]);
		fRec239[0] = (fRec240[0] - (fConst94 * ((fConst114 * fRec239[2]) + (fConst77 * fRec239[1]))));
		fRec238[0] = ((fConst94 * (fRec239[2] + (fRec239[0] + (2.0 * fRec239[1])))) - (fConst93 * ((fConst115 * fRec238[2]) + (fConst77 * fRec238[1]))));
		double fTemp99 = (fConst100 * fRec247[1]);
		fRec247[0] = (fRec229[0] - (fConst99 * ((fConst107 * fRec247[2]) + fTemp99)));
		fRec248[0] = (0.0 - (fConst112 * ((fConst113 * fRec248[1]) - (fRec246[1] + fRec246[2]))));
		fRec246[0] = ((fConst99 * ((fTemp99 + (fConst109 * fRec247[0])) + (fConst110 * fRec247[2]))) - fRec248[0]);
		fRec245[0] = (fRec246[0] - (fConst117 * ((fConst118 * fRec245[2]) + (fConst119 * fRec245[1]))));
		fRec244[0] = ((fConst117 * (fRec245[2] + (fRec245[0] + (2.0 * fRec245[1])))) - (fConst116 * ((fConst120 * fRec244[2]) + (fConst119 * fRec244[1]))));
		double fTemp100 = (fTemp20 + (iSlow6?(iSlow8?(fConst116 * (fRec244[2] + (fRec244[0] + (2.0 * fRec244[1])))):(fConst93 * (fRec238[2] + (fRec238[0] + (2.0 * fRec238[1]))))):(iSlow8?(fConst86 * (fRec236[2] + (fRec236[0] + (2.0 * fRec236[1])))):(fConst56 * (fRec226[2] + (fRec226[0] + (2.0 * fRec226[1])))))));
		fVec41[(IOTA & 8191)] = fTemp100;
		double fTemp101 = ((fTemp13 * fVec41[((IOTA - iTemp22) & 8191)]) + (fRec18[0] * fVec41[((IOTA - iTemp23) & 8191)]));
		fVec42[(IOTA & 8191)] = fTemp101;
		fRec249[0] = (0.0 - (((fSlow10 * fRec249[1]) - (fRec225[1] + fRec225[2])) / fSlow11));
		fRec225[0] = (((fTemp10 * fVec42[((IOTA - iTemp25) & 8191)]) + (fRec11[0] * fVec42[((IOTA - iTemp26) & 8191)])) - fRec249[0]);
		fRec217[0] = ((iSlow0?fRec225[0]:fTemp94) - (fConst131 * fRec217[1]));
		double fTemp102 = (fConst6 * ((fTemp27 * fRec217[1]) + (0.00025707707823962699 * (fRec217[0] * fTemp28))));
		fRec216[0] = ((int(signbit(double(fTemp102)))?double(output12au7_negclip(double(fTemp102))):double(output12au7clip(double(fTemp102)))) - (fConst3 * ((fConst132 * fRec216[2]) + (fConst133 * fRec216[1]))));
		fRec257[0] = (0.0 - (fConst142 * ((fConst26 * fRec257[1]) - (fConst12 * (fTemp90 + fVec37[1])))));
		fRec256[0] = (fRec257[0] - (fConst134 * ((fConst138 * fRec256[2]) + (fConst30 * fRec256[1]))));
		double fTemp103 = (fRec256[2] + (fRec256[0] + (2.0 * fRec256[1])));
		fVec43[0] = fTemp103;
		fRec255[0] = ((fConst134 * ((fConst141 * fTemp103) + (fConst143 * fVec43[1]))) - (fConst144 * fRec255[1]));
		fRec254[0] = (fRec255[0] - (fConst140 * ((fConst145 * fRec254[2]) + (fConst39 * fRec254[1]))));
		double fTemp104 = (fConst48 * fRec253[1]);
		fRec253[0] = ((fConst140 * (((fConst38 * fRec254[0]) + (fConst146 * fRec254[1])) + (fConst38 * fRec254[2]))) - (fConst43 * ((fConst45 * fRec253[2]) + fTemp104)));
		fRec252[0] = ((fRec253[2] + (fConst43 * (fTemp104 + (fConst45 * fRec253[0])))) - (fConst49 * fRec252[1]));
		double fTemp105 = (fConst9 * ((fRec252[0] * fTemp4) + (0.00027518994799636398 * (fRec8[0] * fRec252[1]))));
		double fTemp106 = (int(signbit(double(fTemp105)))?double(input12au7_negclip(double(fTemp105))):double(input12au7clip(double(fTemp105))));
		fVec44[0] = fTemp106;
		fRec268[0] = (0.0 - (((fSlow10 * fRec268[1]) - (fTemp106 + fVec44[1])) / fSlow11));
		fRec267[0] = (fRec268[0] - (0.29999999999999999 * fRec267[1]));
		fRec266[0] = (((2.0 / (std::exp((0.0 - (5.0 * fRec267[0]))) + 1.0)) + (0.29999999999999999 * fRec266[1])) + -1.0);
		fRec265[0] = (0.0 - (fConst73 * ((fConst74 * fRec265[1]) - (fRec266[0] + fRec266[1]))));
		fRec264[0] = (fRec265[0] - (fConst72 * ((fConst76 * fRec264[2]) + (fConst77 * fRec264[1]))));
		double fTemp107 = (fRec264[2] + (fRec264[0] + (2.0 * fRec264[1])));
		fVec45[0] = fTemp107;
		fRec263[0] = ((fConst72 * ((fConst70 * fTemp107) + (fConst71 * fVec45[1]))) - (fConst79 * fRec263[1]));
		fRec262[0] = ((fConst71 * fRec263[1]) - (fConst80 * ((fConst78 * fRec262[1]) - (fConst68 * fRec263[0]))));
		double fTemp108 = (fConst66 * fRec261[1]);
		fRec261[0] = (fRec262[0] - (fConst65 * ((fConst81 * fRec261[2]) + fTemp108)));
		double fTemp109 = ((fTemp108 + (fConst83 * fRec261[0])) + (fConst84 * fRec261[2]));
		fVec46[0] = fTemp109;
		fRec260[0] = (0.0 - (fConst59 * ((fConst60 * fRec260[1]) - (fConst65 * (fTemp109 + fVec46[1])))));
		fRec259[0] = (fRec260[0] - (fConst56 * ((fConst85 * fRec259[2]) + (fConst77 * fRec259[1]))));
		fRec270[0] = (0.0 - (fConst89 * ((fConst90 * fRec270[1]) - (fRec262[0] + fRec262[1]))));
		fRec269[0] = (fRec270[0] - (fConst86 * ((fConst91 * fRec269[2]) + (fConst92 * fRec269[1]))));
		fRec275[0] = ((fConst104 * fRec263[1]) - (fConst105 * ((fConst106 * fRec275[1]) - (fConst102 * fRec263[0]))));
		double fTemp110 = (fConst100 * fRec274[1]);
		fRec274[0] = (fRec275[0] - (fConst99 * ((fConst107 * fRec274[2]) + fTemp110)));
		fRec276[0] = (0.0 - (fConst112 * ((fConst113 * fRec276[1]) - (fRec273[1] + fRec273[2]))));
		fRec273[0] = ((fConst99 * ((fTemp110 + (fConst109 * fRec274[0])) + (fConst110 * fRec274[2]))) - fRec276[0]);
		fRec272[0] = (fRec273[0] - (fConst94 * ((fConst114 * fRec272[2]) + (fConst77 * fRec272[1]))));
		fRec271[0] = ((fConst94 * (fRec272[2] + (fRec272[0] + (2.0 * fRec272[1])))) - (fConst93 * ((fConst115 * fRec271[2]) + (fConst77 * fRec271[1]))));
		double fTemp111 = (fConst100 * fRec280[1]);
		fRec280[0] = (fRec262[0] - (fConst99 * ((fConst107 * fRec280[2]) + fTemp111)));
		fRec281[0] = (0.0 - (fConst112 * ((fConst113 * fRec281[1]) - (fRec279[1] + fRec279[2]))));
		fRec279[0] = ((fConst99 * ((fTemp111 + (fConst109 * fRec280[0])) + (fConst110 * fRec280[2]))) - fRec281[0]);
		fRec278[0] = (fRec279[0] - (fConst117 * ((fConst118 * fRec278[2]) + (fConst119 * fRec278[1]))));
		fRec277[0] = ((fConst117 * (fRec278[2] + (fRec278[0] + (2.0 * fRec278[1])))) - (fConst116 * ((fConst120 * fRec277[2]) + (fConst119 * fRec277[1]))));
		double fTemp112 = (fTemp20 + (iSlow6?(iSlow8?(fConst116 * (fRec277[2] + (fRec277[0] + (2.0 * fRec277[1])))):(fConst93 * (fRec271[2] + (fRec271[0] + (2.0 * fRec271[1]))))):(iSlow8?(fConst86 * (fRec269[2] + (fRec269[0] + (2.0 * fRec269[1])))):(fConst56 * (fRec259[2] + (fRec259[0] + (2.0 * fRec259[1])))))));
		fVec47[(IOTA & 8191)] = fTemp112;
		double fTemp113 = ((fTemp13 * fVec47[((IOTA - iTemp22) & 8191)]) + (fRec18[0] * fVec47[((IOTA - iTemp23) & 8191)]));
		fVec48[(IOTA & 8191)] = fTemp113;
		fRec282[0] = (0.0 - (((fSlow10 * fRec282[1]) - (fRec258[1] + fRec258[2])) / fSlow11));
		fRec258[0] = (((fTemp10 * fVec48[((IOTA - iTemp25) & 8191)]) + (fRec11[0] * fVec48[((IOTA - iTemp26) & 8191)])) - fRec282[0]);
		fRec251[0] = ((iSlow0?fRec258[0]:fTemp106) - (fConst131 * fRec251[1]));
		double fTemp114 = (fConst6 * ((fTemp27 * fRec251[1]) + (0.00025707707823962699 * (fRec251[0] * fTemp28))));
		fRec250[0] = ((int(signbit(double(fTemp114)))?double(output12au7_negclip(double(fTemp114))):double(output12au7clip(double(fTemp114)))) - (fConst3 * ((fConst132 * fRec250[2]) + (fConst133 * fRec250[1]))));
		fRec289[0] = (0.0 - (fConst149 * ((fConst35 * fRec289[1]) - (fConst134 * (fTemp103 + fVec43[1])))));
		fRec288[0] = (fRec289[0] - (fConst140 * ((fConst145 * fRec288[2]) + (fConst39 * fRec288[1]))));
		double fTemp115 = (fRec288[2] + (fRec288[0] + (2.0 * fRec288[1])));
		fVec49[0] = fTemp115;
		fRec287[0] = ((fConst140 * ((fConst148 * fTemp115) + (fConst150 * fVec49[1]))) - (fConst151 * fRec287[1]));
		fRec286[0] = (fRec287[0] - (fConst147 * ((fConst152 * fRec286[2]) + (fConst48 * fRec286[1]))));
		fRec285[0] = ((fConst147 * (((fConst47 * fRec286[0]) + (fConst153 * fRec286[1])) + (fConst47 * fRec286[2]))) - (fConst49 * fRec285[1]));
		double fTemp116 = (fConst9 * ((fRec285[0] * fTemp4) + (0.00027518994799636398 * (fRec8[0] * fRec285[1]))));
		double fTemp117 = (int(signbit(double(fTemp116)))?double(input12au7_negclip(double(fTemp116))):double(input12au7clip(double(fTemp116))));
		fVec50[0] = fTemp117;
		fRec300[0] = (0.0 - (((fSlow10 * fRec300[1]) - (fTemp117 + fVec50[1])) / fSlow11));
		fRec299[0] = (fRec300[0] - (0.29999999999999999 * fRec299[1]));
		fRec298[0] = (((2.0 / (std::exp((0.0 - (5.0 * fRec299[0]))) + 1.0)) + (0.29999999999999999 * fRec298[1])) + -1.0);
		fRec297[0] = (0.0 - (fConst73 * ((fConst74 * fRec297[1]) - (fRec298[0] + fRec298[1]))));
		fRec296[0] = (fRec297[0] - (fConst72 * ((fConst76 * fRec296[2]) + (fConst77 * fRec296[1]))));
		double fTemp118 = (fRec296[2] + (fRec296[0] + (2.0 * fRec296[1])));
		fVec51[0] = fTemp118;
		fRec295[0] = ((fConst72 * ((fConst70 * fTemp118) + (fConst71 * fVec51[1]))) - (fConst79 * fRec295[1]));
		fRec294[0] = ((fConst71 * fRec295[1]) - (fConst80 * ((fConst78 * fRec294[1]) - (fConst68 * fRec295[0]))));
		double fTemp119 = (fConst66 * fRec293[1]);
		fRec293[0] = (fRec294[0] - (fConst65 * ((fConst81 * fRec293[2]) + fTemp119)));
		double fTemp120 = ((fTemp119 + (fConst83 * fRec293[0])) + (fConst84 * fRec293[2]));
		fVec52[0] = fTemp120;
		fRec292[0] = (0.0 - (fConst59 * ((fConst60 * fRec292[1]) - (fConst65 * (fTemp120 + fVec52[1])))));
		fRec291[0] = (fRec292[0] - (fConst56 * ((fConst85 * fRec291[2]) + (fConst77 * fRec291[1]))));
		fRec302[0] = (0.0 - (fConst89 * ((fConst90 * fRec302[1]) - (fRec294[0] + fRec294[1]))));
		fRec301[0] = (fRec302[0] - (fConst86 * ((fConst91 * fRec301[2]) + (fConst92 * fRec301[1]))));
		fRec307[0] = ((fConst104 * fRec295[1]) - (fConst105 * ((fConst106 * fRec307[1]) - (fConst102 * fRec295[0]))));
		double fTemp121 = (fConst100 * fRec306[1]);
		fRec306[0] = (fRec307[0] - (fConst99 * ((fConst107 * fRec306[2]) + fTemp121)));
		fRec308[0] = (0.0 - (fConst112 * ((fConst113 * fRec308[1]) - (fRec305[1] + fRec305[2]))));
		fRec305[0] = ((fConst99 * ((fTemp121 + (fConst109 * fRec306[0])) + (fConst110 * fRec306[2]))) - fRec308[0]);
		fRec304[0] = (fRec305[0] - (fConst94 * ((fConst114 * fRec304[2]) + (fConst77 * fRec304[1]))));
		fRec303[0] = ((fConst94 * (fRec304[2] + (fRec304[0] + (2.0 * fRec304[1])))) - (fConst93 * ((fConst115 * fRec303[2]) + (fConst77 * fRec303[1]))));
		double fTemp122 = (fConst100 * fRec312[1]);
		fRec312[0] = (fRec294[0] - (fConst99 * ((fConst107 * fRec312[2]) + fTemp122)));
		fRec313[0] = (0.0 - (fConst112 * ((fConst113 * fRec313[1]) - (fRec311[1] + fRec311[2]))));
		fRec311[0] = ((fConst99 * ((fTemp122 + (fConst109 * fRec312[0])) + (fConst110 * fRec312[2]))) - fRec313[0]);
		fRec310[0] = (fRec311[0] - (fConst117 * ((fConst118 * fRec310[2]) + (fConst119 * fRec310[1]))));
		fRec309[0] = ((fConst117 * (fRec310[2] + (fRec310[0] + (2.0 * fRec310[1])))) - (fConst116 * ((fConst120 * fRec309[2]) + (fConst119 * fRec309[1]))));
		double fTemp123 = (fTemp20 + (iSlow6?(iSlow8?(fConst116 * (fRec309[2] + (fRec309[0] + (2.0 * fRec309[1])))):(fConst93 * (fRec303[2] + (fRec303[0] + (2.0 * fRec303[1]))))):(iSlow8?(fConst86 * (fRec301[2] + (fRec301[0] + (2.0 * fRec301[1])))):(fConst56 * (fRec291[2] + (fRec291[0] + (2.0 * fRec291[1])))))));
		fVec53[(IOTA & 8191)] = fTemp123;
		double fTemp124 = ((fTemp13 * fVec53[((IOTA - iTemp22) & 8191)]) + (fRec18[0] * fVec53[((IOTA - iTemp23) & 8191)]));
		fVec54[(IOTA & 8191)] = fTemp124;
		fRec314[0] = (0.0 - (((fSlow10 * fRec314[1]) - (fRec290[1] + fRec290[2])) / fSlow11));
		fRec290[0] = (((fTemp10 * fVec54[((IOTA - iTemp25) & 8191)]) + (fRec11[0] * fVec54[((IOTA - iTemp26) & 8191)])) - fRec314[0]);
		fRec284[0] = ((iSlow0?fRec290[0]:fTemp117) - (fConst131 * fRec284[1]));
		double fTemp125 = (fConst6 * ((fTemp27 * fRec284[1]) + (0.00025707707823962699 * (fRec284[0] * fTemp28))));
		fRec283[0] = ((int(signbit(double(fTemp125)))?double(output12au7_negclip(double(fTemp125))):double(output12au7clip(double(fTemp125)))) - (fConst3 * ((fConst132 * fRec283[2]) + (fConst133 * fRec283[1]))));
		fRec319[0] = (0.0 - (fConst154 * ((fConst44 * fRec319[1]) - (fConst140 * (fTemp115 + fVec49[1])))));
		fRec318[0] = (fRec319[0] - (fConst147 * ((fConst152 * fRec318[2]) + (fConst48 * fRec318[1]))));
		fRec317[0] = ((fConst147 * (fRec318[2] + (fRec318[0] + (2.0 * fRec318[1])))) - (fConst49 * fRec317[1]));
		double fTemp126 = (fConst9 * ((fRec317[0] * fTemp4) + (0.00027518994799636398 * (fRec8[0] * fRec317[1]))));
		double fTemp127 = (int(signbit(double(fTemp126)))?double(input12au7_negclip(double(fTemp126))):double(input12au7clip(double(fTemp126))));
		fVec55[0] = fTemp127;
		fRec330[0] = (0.0 - (((fSlow10 * fRec330[1]) - (fTemp127 + fVec55[1])) / fSlow11));
		fRec329[0] = (fRec330[0] - (0.29999999999999999 * fRec329[1]));
		fRec328[0] = (((2.0 / (std::exp((0.0 - (5.0 * fRec329[0]))) + 1.0)) + (0.29999999999999999 * fRec328[1])) + -1.0);
		fRec327[0] = (0.0 - (fConst73 * ((fConst74 * fRec327[1]) - (fRec328[0] + fRec328[1]))));
		fRec326[0] = (fRec327[0] - (fConst72 * ((fConst76 * fRec326[2]) + (fConst77 * fRec326[1]))));
		double fTemp128 = (fRec326[2] + (fRec326[0] + (2.0 * fRec326[1])));
		fVec56[0] = fTemp128;
		fRec325[0] = ((fConst72 * ((fConst70 * fTemp128) + (fConst71 * fVec56[1]))) - (fConst79 * fRec325[1]));
		fRec324[0] = ((fConst71 * fRec325[1]) - (fConst80 * ((fConst78 * fRec324[1]) - (fConst68 * fRec325[0]))));
		double fTemp129 = (fConst66 * fRec323[1]);
		fRec323[0] = (fRec324[0] - (fConst65 * ((fConst81 * fRec323[2]) + fTemp129)));
		double fTemp130 = ((fTemp129 + (fConst83 * fRec323[0])) + (fConst84 * fRec323[2]));
		fVec57[0] = fTemp130;
		fRec322[0] = (0.0 - (fConst59 * ((fConst60 * fRec322[1]) - (fConst65 * (fTemp130 + fVec57[1])))));
		fRec321[0] = (fRec322[0] - (fConst56 * ((fConst85 * fRec321[2]) + (fConst77 * fRec321[1]))));
		fRec332[0] = (0.0 - (fConst89 * ((fConst90 * fRec332[1]) - (fRec324[0] + fRec324[1]))));
		fRec331[0] = (fRec332[0] - (fConst86 * ((fConst91 * fRec331[2]) + (fConst92 * fRec331[1]))));
		fRec337[0] = ((fConst104 * fRec325[1]) - (fConst105 * ((fConst106 * fRec337[1]) - (fConst102 * fRec325[0]))));
		double fTemp131 = (fConst100 * fRec336[1]);
		fRec336[0] = (fRec337[0] - (fConst99 * ((fConst107 * fRec336[2]) + fTemp131)));
		fRec338[0] = (0.0 - (fConst112 * ((fConst113 * fRec338[1]) - (fRec335[1] + fRec335[2]))));
		fRec335[0] = ((fConst99 * ((fTemp131 + (fConst109 * fRec336[0])) + (fConst110 * fRec336[2]))) - fRec338[0]);
		fRec334[0] = (fRec335[0] - (fConst94 * ((fConst114 * fRec334[2]) + (fConst77 * fRec334[1]))));
		fRec333[0] = ((fConst94 * (fRec334[2] + (fRec334[0] + (2.0 * fRec334[1])))) - (fConst93 * ((fConst115 * fRec333[2]) + (fConst77 * fRec333[1]))));
		double fTemp132 = (fConst100 * fRec342[1]);
		fRec342[0] = (fRec324[0] - (fConst99 * ((fConst107 * fRec342[2]) + fTemp132)));
		fRec343[0] = (0.0 - (fConst112 * ((fConst113 * fRec343[1]) - (fRec341[1] + fRec341[2]))));
		fRec341[0] = ((fConst99 * ((fTemp132 + (fConst109 * fRec342[0])) + (fConst110 * fRec342[2]))) - fRec343[0]);
		fRec340[0] = (fRec341[0] - (fConst117 * ((fConst118 * fRec340[2]) + (fConst119 * fRec340[1]))));
		fRec339[0] = ((fConst117 * (fRec340[2] + (fRec340[0] + (2.0 * fRec340[1])))) - (fConst116 * ((fConst120 * fRec339[2]) + (fConst119 * fRec339[1]))));
		double fTemp133 = (fTemp20 + (iSlow6?(iSlow8?(fConst116 * (fRec339[2] + (fRec339[0] + (2.0 * fRec339[1])))):(fConst93 * (fRec333[2] + (fRec333[0] + (2.0 * fRec333[1]))))):(iSlow8?(fConst86 * (fRec331[2] + (fRec331[0] + (2.0 * fRec331[1])))):(fConst56 * (fRec321[2] + (fRec321[0] + (2.0 * fRec321[1])))))));
		fVec58[(IOTA & 8191)] = fTemp133;
		double fTemp134 = ((fTemp13 * fVec58[((IOTA - iTemp22) & 8191)]) + (fRec18[0] * fVec58[((IOTA - iTemp23) & 8191)]));
		fVec59[(IOTA & 8191)] = fTemp134;
		fRec344[0] = (0.0 - (((fSlow10 * fRec344[1]) - (fRec320[1] + fRec320[2])) / fSlow11));
		fRec320[0] = (((fTemp10 * fVec59[((IOTA - iTemp25) & 8191)]) + (fRec11[0] * fVec59[((IOTA - iTemp26) & 8191)])) - fRec344[0]);
		fRec316[0] = ((iSlow0?fRec320[0]:fTemp127) - (fConst131 * fRec316[1]));
		double fTemp135 = (fConst6 * ((fTemp27 * fRec316[1]) + (0.00025707707823962699 * (fRec316[0] * fTemp28))));
		fRec315[0] = ((int(signbit(double(fTemp135)))?double(output12au7_negclip(double(fTemp135))):double(output12au7clip(double(fTemp135)))) - (fConst3 * ((fConst132 * fRec315[2]) + (fConst133 * fRec315[1]))));
		output1[i] = FAUSTFLOAT((fConst3 * (((((fRec183[2] + (fRec183[0] + (2.0 * fRec183[1]))) + (fRec216[2] + (fRec216[0] + (2.0 * fRec216[1])))) + (fRec250[2] + (fRec250[0] + (2.0 * fRec250[1])))) + (fRec283[2] + (fRec283[0] + (2.0 * fRec283[1])))) + (fRec315[2] + (fRec315[0] + (2.0 * fRec315[1]))))));
		fVec0[1] = fVec0[0];
		iVec1[1] = iVec1[0];
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
