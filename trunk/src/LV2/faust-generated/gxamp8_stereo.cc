...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec100[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec101[0] + fRec101[2])) + (fRec103[0] + (1.8508996845035413 * fRec101[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		fRec99[0] = ((0.10000000000000001 * ((fConst4 * fRec100[0]) + (fConst27 * fRec100[1]))) - (fConst28 * fRec99[1]));
		...
		fRec111[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec112[0] + fRec112[2])) + (fRec114[0] + (1.8508996845035413 * fRec112[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		fRec110[0] = ((0.10000000000000001 * ((fConst4 * fRec111[0]) + (fConst27 * fRec111[1]))) - (fConst28 * fRec110[1]));
		double fTemp49 = double(input1[i]);
		fVec24[0] = fTemp49;
		fRec122[0] = (fConst38 * ((fTemp49 - fVec24[1]) + (fConst39 * fRec122[1])));
		fRec121[0] = (fConst38 * ((fRec122[0] - fRec122[1]) + (fConst39 * fRec121[1])));
		fRec120[0] = (fRec121[0] - (fConst36 * ((fConst40 * fRec120[2]) + (fConst41 * fRec120[1]))));
		fRec119[0] = ((fConst36 * (fRec120[2] + (fRec120[0] + (2.0 * fRec120[1])))) - (fConst42 * ((fConst43 * fRec119[2]) + (fConst41 * fRec119[1]))));
		double fTemp50 = ((fConst35 * (fRec46[0] * (fRec119[2] + (fRec119[0] + (2.0 * fRec119[1]))))) + 1.0000000000000001e-15);
		fVec25[0] = fTemp50;
		...
		fVec26[0] = fTemp51;
		fRec123[0] = (0.0 - (fConst45 * ((fConst46 * fRec123[1]) - (fTemp51 + fVec26[1]))));
		fRec116[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec117[0] + fRec117[2])) + (fRec123[0] + (1.8508996845035413 * fRec117[1]))) + -1.2572399999999999)))) + -83.435555555555567);
		fRec115[0] = ((0.10000000000000001 * ((fConst4 * fRec116[0]) + (fConst27 * fRec116[1]))) - (fConst28 * fRec115[1]));
		...
		fRec105[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec106[0] + fRec106[2])) + (fRec124[0] + (1.8508996845035413 * fRec106[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		fRec104[0] = ((0.10000000000000001 * ((fConst4 * fRec105[0]) + (fConst27 * fRec105[1]))) - (fConst28 * fRec104[1]));
		...
		fRec95[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec96[0] + fRec96[2])) + (fRec125[0] + (1.8508996845035413 * fRec96[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		fRec94[0] = ((0.10000000000000001 * ((fConst4 * fRec95[0]) + (fConst27 * fRec95[1]))) - (fConst28 * fRec94[1]));
		...
		fRec128[0] = ((fTemp58 + fRec128[1]) - fVec31[((IOTA - iConst48) & 32767)]);
		fRec127[0] = ((0.999 * fRec127[1]) + (fConst47 * fRec128[0]));
		...
		fRec93[0] = ((0.024937655860349125 * fTemp65) - (fConst23 * ((fConst49 * fRec93[2]) + (fConst50 * fRec93[1]))));
		...
		fRec90[0] = (fRec91[0] - (fConst15 * ((fConst51 * fRec90[2]) + (fConst54 * fRec90[1]))));
		double fTemp67 = (fRec90[2] + (fRec90[0] + (2.0 * fRec90[1])));
		fVec33[0] = fTemp67;
		fRec89[0] = ((fConst15 * ((fConst17 * fTemp67) + (fConst55 * fVec33[1]))) - (fConst57 * fRec89[1]));
		fRec88[0] = (fRec89[0] - (fConst10 * ((fConst58 * fRec88[2]) + (fConst59 * fRec88[1]))));
		double fTemp68 = (fConst69 * fRec87[1]);
		fRec87[0] = ((fConst10 * (((fConst12 * fRec88[0]) + (fConst60 * fRec88[1])) + (fConst12 * fRec88[2]))) - (fConst64 * ((fConst66 * fRec87[2]) + fTemp68)));
		double fTemp69 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow3 * (fRec87[2] + (fConst64 * (fTemp68 + (fConst66 * fRec87[0])))))));
		fRec132[0] = ((fConst70 * fRec92[1]) - (fConst19 * ((fConst20 * fRec132[1]) - (fConst14 * fRec92[0]))));
		fRec131[0] = (fRec132[0] - (fConst15 * ((fConst51 * fRec131[2]) + (fConst54 * fRec131[1]))));
		double fTemp70 = (fConst59 * fRec130[1]);
		fRec130[0] = ((fConst15 * (((fConst53 * fRec131[0]) + (fConst71 * fRec131[1])) + (fConst53 * fRec131[2]))) - (fConst72 * ((fConst73 * fRec130[2]) + fTemp70)));
		double fTemp71 = (fConst69 * fRec129[1]);
		fRec129[0] = ((fRec130[2] + (fConst72 * (fTemp70 + (fConst73 * fRec130[0])))) - (fConst64 * ((fConst66 * fRec129[2]) + fTemp71)));
		double fTemp72 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec129[2] + (fConst64 * (fTemp71 + (fConst66 * fRec129[0])))))));
		fRec136[0] = (0.0 - (fConst76 * ((fConst56 * fRec136[1]) - (fConst15 * (fTemp67 + fVec33[1])))));
		fRec135[0] = (fRec136[0] - (fConst10 * ((fConst58 * fRec135[2]) + (fConst59 * fRec135[1]))));
		double fTemp73 = (fRec135[2] + (fRec135[0] + (2.0 * fRec135[1])));
		fVec34[0] = fTemp73;
		fRec134[0] = ((fConst10 * ((fConst75 * fTemp73) + (fConst77 * fVec34[1]))) - (fConst78 * fRec134[1]));
		fRec133[0] = (fRec134[0] - (fConst74 * ((fConst79 * fRec133[2]) + (fConst69 * fRec133[1]))));
		double fTemp74 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst68 * fRec133[0]) + (fConst80 * fRec133[1])) + (fConst68 * fRec133[2])))));
		fRec138[0] = (0.0 - (fConst81 * ((fConst65 * fRec138[1]) - (fConst10 * (fTemp73 + fVec34[1])))));
		fRec137[0] = (fRec138[0] - (fConst74 * ((fConst79 * fRec137[2]) + (fConst69 * fRec137[1]))));
