...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst2 = (fConst1 + 0.0044271440520969102);
	...
	fConst43 = (2.4303358425833099e-15 * fConst0);
	fConst44 = (((-1.34509147324758e-10 - fConst43) * fConst0) + 6.3306072420472404e-08);
	fConst45 = (6.8704107329372702e-14 * fConst0);
	fConst46 = (((1.12102439518276e-11 - fConst45) * fConst0) + -3.4546917434926099e-10);
	fConst47 = (7.1134443171955998e-14 * fConst0);
	fConst48 = ((fConst47 + 6.9093834869852202e-13) * fConst0);
	fConst49 = (((fConst43 + -1.34509147324758e-10) * fConst0) + -6.3306072420472404e-08);
	fConst50 = (((fConst45 + 1.12102439518276e-11) * fConst0) + 3.4546917434926099e-10);
	fConst51 = ((6.9093834869852202e-13 - fConst47) * fConst0);
	fConst52 = (8.1011194752777097e-16 * fConst0);
	fConst53 = (((1.34509147324758e-10 - fConst52) * fConst0) + -6.3306072420472404e-08);
	fConst54 = (2.2901369109790902e-14 * fConst0);
	fConst55 = (((-1.12102439518276e-11 - fConst54) * fConst0) + 3.4546917434926099e-10);
	fConst56 = (2.3711481057318699e-14 * fConst0);
	fConst57 = ((fConst56 + -6.9093834869852202e-13) * fConst0);
	fConst58 = (((fConst52 + 1.34509147324758e-10) * fConst0) + 6.3306072420472404e-08);
	fConst59 = (((fConst54 + -1.12102439518276e-11) * fConst0) + -3.4546917434926099e-10);
	fConst60 = ((-6.9093834869852202e-13 - fConst56) * fConst0);
	fConst61 = (1.44375296887024e-12 * fConst0);
	fConst62 = (((-7.2406398893340597e-09 - fConst61) * fConst0) + -1.0937522491441e-07);
	fConst63 = ((fConst61 + 2.1875044982882e-11) * fConst0);
	fConst64 = (4.3312589066107104e-12 * fConst0);
	fConst65 = (((fConst64 + 7.2406398893340597e-09) * fConst0) + -1.0937522491441e-07);
	fConst66 = ((-2.1875044982882e-11 - fConst64) * fConst0);
	fConst67 = (((7.2406398893340597e-09 - fConst64) * fConst0) + 1.0937522491441e-07);
	fConst68 = ((fConst64 + -2.1875044982882e-11) * fConst0);
	fConst69 = (((fConst61 + -7.2406398893340597e-09) * fConst0) + 1.0937522491441e-07);
	fConst70 = ((2.1875044982882e-11 - fConst61) * fConst0);
...
#define fVslider1 (*fVslider1_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec0[0] = ((int(signbit(double(fTemp12)))?double(w20_1_negclip(double(fTemp12))):double(w20_1clip(double(fTemp12)))) - (fConst71 * fRec0[1]));
		...
		fRec16[0] = (0.0 - (fConst11 * ((fConst12 * fRec16[1]) - (fVec0[1] + fTemp0))));
		...
		fRec9[0] = ((int(signbit(double(fTemp18)))?double(w20_1_negclip(double(fTemp18))):double(w20_1clip(double(fTemp18)))) - (fConst71 * fRec9[1]));
		...
		fRec17[0] = ((int(signbit(double(fTemp22)))?double(w20_1_negclip(double(fTemp22))):double(w20_1clip(double(fTemp22)))) - (fConst71 * fRec17[1]));
		...
		fRec24[0] = ((int(signbit(double(fTemp25)))?double(w20_1_negclip(double(fTemp25))):double(w20_1clip(double(fTemp25)))) - (fConst71 * fRec24[1]));
		...
		fRec30[0] = ((int(signbit(double(fTemp27)))?double(w20_1_negclip(double(fTemp27))):double(w20_1clip(double(fTemp27)))) - (fConst71 * fRec30[1]));
		double fTemp28 = (fConst3 * ((fRec30[0] * fTemp13) + (0.00061610099403943601 * (fRec8[0] * fRec30[1]))));
		output0[i] = FAUSTFLOAT((((((int(signbit(double(fTemp14)))?double(w20_2a_negclip(double(fTemp14))):double(w20_2aclip(double(fTemp14)))) + (int(signbit(double(fTemp19)))?double(w20_2a_negclip(double(fTemp19))):double(w20_2aclip(double(fTemp19))))) + (int(signbit(double(fTemp23)))?double(w20_2a_negclip(double(fTemp23))):double(w20_2aclip(double(fTemp23))))) + (int(signbit(double(fTemp26)))?double(w20_2a_negclip(double(fTemp26))):double(w20_2aclip(double(fTemp26))))) + (int(signbit(double(fTemp28)))?double(w20_2a_negclip(double(fTemp28))):double(w20_2aclip(double(fTemp28))))));
		fRec1[1] = fRec1[0];
		fVec0[1] = fVec0[0];
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
