// generated from file '../src/LV2/faust/tonestack_princeton_stereo.dsp' by dsp2cc:
// Code generated with Faust (https://faust.grame.fr)


namespace tonestack_princeton_stereo {
...
} // end namespace tonestack_princeton_stereo
