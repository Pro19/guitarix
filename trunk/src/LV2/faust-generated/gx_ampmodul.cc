...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp1 = ((fRec16[0] * fTemp0) + 1.0000000000000001e-15);
		fVec0[0] = fTemp1;
		...
		double fTemp2 = ((0.027 * fRec13[1]) + 1.0000000000000001e-15);
		fVec1[0] = fTemp2;
		fRec17[0] = (0.0 - (fConst9 * ((fConst10 * fRec17[1]) - (fTemp2 + fVec1[1]))));
		...
		double fTemp3 = ((fRec11[0] * fRec18[0]) + 1.0000000000000001e-15);
		fVec2[0] = fTemp3;
		fRec10[0] = ((0.93028479253239138 * (fTemp3 + fVec2[1])) - (0.86056958506478287 * fRec10[1]));
		fRec9[0] = (fRec10[0] - ((1.8405051250752198 * fRec9[1]) + (0.86129424393186271 * fRec9[2])));
		double fTemp4 = ((0.014999999999999999 * fRec8[1]) + 1.0000000000000001e-15);
		fVec3[0] = fTemp4;
		fRec19[0] = (0.0 - (fConst14 * ((fConst15 * fRec19[1]) - (fTemp4 + fVec3[1]))));
		...
		double fTemp5 = ((fRec6[0] * fRec20[0]) + 1.0000000000000001e-15);
		fVec4[0] = fTemp5;
		fRec5[0] = ((0.93028479253239138 * (fTemp5 + fVec4[1])) - (0.86056958506478287 * fRec5[1]));
		fRec4[0] = (fRec5[0] - ((1.8405051250752198 * fRec4[1]) + (0.86129424393186271 * fRec4[2])));
		double fTemp6 = ((0.0082000000000000007 * fRec3[1]) + 1.0000000000000001e-15);
		fVec5[0] = fTemp6;
		fRec21[0] = (0.0 - (fConst17 * ((fConst18 * fRec21[1]) - (fTemp6 + fVec5[1]))));
		...
		fRec22[0] = (-1.0 * ((fSlow2 * fRec22[5]) - fTemp7));
		double fTemp8 = ((fRec16[0] * fTemp7) + 1.0000000000000001e-15);
		fVec6[0] = fTemp8;
		fRec37[0] = ((0.93028479253239138 * (fTemp8 + fVec6[1])) - (0.86056958506478287 * fRec37[1]));
		fRec36[0] = (fRec37[0] - ((1.8405051250752198 * fRec36[1]) + (0.86129424393186271 * fRec36[2])));
		double fTemp9 = ((0.027 * fRec35[1]) + 1.0000000000000001e-15);
		fVec7[0] = fTemp9;
		fRec38[0] = (0.0 - (fConst9 * ((fConst10 * fRec38[1]) - (fTemp9 + fVec7[1]))));
		...
		double fTemp10 = ((fRec18[0] * fRec33[0]) + 1.0000000000000001e-15);
		fVec8[0] = fTemp10;
		fRec32[0] = ((0.93028479253239138 * (fTemp10 + fVec8[1])) - (0.86056958506478287 * fRec32[1]));
		fRec31[0] = (fRec32[0] - ((1.8405051250752198 * fRec31[1]) + (0.86129424393186271 * fRec31[2])));
		double fTemp11 = ((0.014999999999999999 * fRec30[1]) + 1.0000000000000001e-15);
		fVec9[0] = fTemp11;
		fRec39[0] = (0.0 - (fConst14 * ((fConst15 * fRec39[1]) - (fTemp11 + fVec9[1]))));
		...
		double fTemp12 = ((fRec20[0] * fRec28[0]) + 1.0000000000000001e-15);
		fVec10[0] = fTemp12;
		fRec27[0] = ((0.93028479253239138 * (fTemp12 + fVec10[1])) - (0.86056958506478287 * fRec27[1]));
		fRec26[0] = (fRec27[0] - ((1.8405051250752198 * fRec26[1]) + (0.86129424393186271 * fRec26[2])));
		double fTemp13 = ((0.0082000000000000007 * fRec25[1]) + 1.0000000000000001e-15);
		fVec11[0] = fTemp13;
		fRec40[0] = (0.0 - (fConst17 * ((fConst18 * fRec40[1]) - (fTemp13 + fVec11[1]))));
