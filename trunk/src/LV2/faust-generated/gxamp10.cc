...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp22 + (fRec36[0] + fTemp24)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec0[0] = ((0.050000000000000003 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		double fTemp25 = ((0.0082000000000000007 * fRec38[1]) + 1.0000000000000001e-15);
		fVec12[0] = fTemp25;
		fRec39[0] = (0.0 - (fConst66 * ((fConst67 * fRec39[1]) - (fTemp25 + fVec12[1]))));
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp22 + (fRec39[0] + fTemp24)) + -0.79704299999999995)))) + -32.799634146341475);
