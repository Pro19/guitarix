// generated from file '../src/LV2/faust/gxamp15_stereo.dsp' by dsp2cc:
// Code generated with Faust (https://faust.grame.fr)

#include "valve.h"

namespace gxamp15_stereo {
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double((((0.92544984225177063 * (fRec24[0] + fRec24[2])) + (fRec27[0] + (1.8508996845035413 * fRec24[1]))) + -2.617753)))) + -153.04618518518518);
		...
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec19[0] + fRec19[2])) + (fRec28[0] + (1.8508996845035413 * fRec19[1]))) + -1.887332)))) + -124.17786666666666);
		...
		fRec14[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec15[0] + fRec15[2])) + (fRec29[0] + (1.8508996845035413 * fRec15[1]))) + -1.2569619999999999)))) + -96.711951219512201);
		...
		fRec69[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double((((0.92544984225177063 * (fRec70[0] + fRec70[2])) + (fRec72[0] + (1.8508996845035413 * fRec70[1]))) + -2.617753)))) + -153.04618518518518);
		fRec68[0] = ((0.025000000000000001 * ((fConst4 * fRec69[0]) + (fConst27 * fRec69[1]))) - (fConst28 * fRec68[1]));
		...
		fRec64[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec65[0] + fRec65[2])) + (fRec73[0] + (1.8508996845035413 * fRec65[1]))) + -1.887332)))) + -124.17786666666666);
		fRec63[0] = ((0.025000000000000001 * ((fConst4 * fRec64[0]) + (fConst27 * fRec64[1]))) - (fConst28 * fRec63[1]));
		...
		fRec60[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec61[0] + fRec61[2])) + (fRec74[0] + (1.8508996845035413 * fRec61[1]))) + -1.2569619999999999)))) + -96.711951219512201);
		fRec59[0] = ((0.025000000000000001 * ((fConst4 * fRec60[0]) + (fConst27 * fRec60[1]))) - (fConst28 * fRec59[1]));
