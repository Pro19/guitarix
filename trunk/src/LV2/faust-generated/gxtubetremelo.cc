...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst5 = (0.0 - fConst4);
	fConst6 = (2.0824050069881302e-05 * fConst0);
	fConst7 = (fConst6 + 0.00044559664569599199);
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec22[0] = (0.0 - (fConst16 * ((fConst17 * fRec22[1]) - (fVec1[1] + fTemp0))));
		...
		output0[i] = FAUSTFLOAT((fRec0[0] * (((((int(signbit(double(fTemp8)))?double(output12ax7_negclip(double(fTemp8))):double(output12ax7clip(double(fTemp8)))) + (int(signbit(double(fTemp13)))?double(output12ax7_negclip(double(fTemp13))):double(output12ax7clip(double(fTemp13))))) + (int(signbit(double(fTemp17)))?double(output12ax7_negclip(double(fTemp17))):double(output12ax7clip(double(fTemp17))))) + (int(signbit(double(fTemp20)))?double(output12ax7_negclip(double(fTemp20))):double(output12ax7clip(double(fTemp20))))) + (int(signbit(double(fTemp22)))?double(output12ax7_negclip(double(fTemp22))):double(output12ax7clip(double(fTemp22)))))));
		iVec0[1] = iVec0[0];
		fRec0[1] = fRec0[0];
		fVec1[1] = fVec1[0];
		fRec7[1] = fRec7[0];
