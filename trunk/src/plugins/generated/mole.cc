...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		output0[i] = FAUSTFLOAT(((fSlow1 * fTemp0) + (fConst3 * ((((fRec0[0] * fTemp1) + (9.7426834504014603e-11 * (fRec1[0] * fRec0[1]))) + (9.7426834504014603e-11 * (fRec1[0] * fRec0[2]))) + (fRec0[3] * fTemp1)))));
                  ...
                  <object class=\"GtkBox\" id=\"vbox2\">\n\
                    ...
                    <child>\n\
                      <object class=\"GxMidKnob\" id=\"gxbigknob1\">\n\
                        ...
                        <property name=\"var_id\">mole.Boost</property>\n\
                  ...
                  <object class=\"GtkBox\" id=\"vbox3\">\n\
                    ...
                    <child>\n\
                      <object class=\"GxSmallKnobR\" id=\"gxbigknob2\">\n\
                        ...
                        <property name=\"can_focus\">True</property>\n\
                        <property name=\"receives_default\">True</property>\n\
                        <property name=\"var_id\">mole.wet_dry</property>\n\
