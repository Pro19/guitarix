...
{
	reg.registerFloatVar("GCB_95.Volume","","S","",&fVslider0, 0.0, -20.0, 4.0, 0.10000000000000001, 0);
	reg.registerFloatVar("GCB_95.hotpotz",N_("Wah"),"S","",&fVslider1, 0.5, 0.0, 1.0, 0.01, 0);
	return 0;
}
