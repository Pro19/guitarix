...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerFloatVar("flanger_mono_gx.mix",N_("Mix"),"S","",&fHslider0, 0.0, -1.0, 1.0, 0.10000000000000001, 0);
	reg.registerFloatVar("flanger_mono_gx.wet",N_("Wet"),"S","",&fHslider1, 100.0, 0.0, 100.0, 1.0, 0);
