...
{
	reg.registerFloatVar("mbclip.Drive1","","S",N_("Amount of distortion"),&fHslider8, 0.33000000000000002, 0.0, 1.0, 0.01, 0);
	reg.registerFloatVar("mbclip.Drive2","","S",N_("Amount of distortion"),&fHslider7, 0.5, 0.0, 1.0, 0.01, 0);
	reg.registerFloatVar("mbclip.Drive3","","S",N_("Amount of distortion"),&fHslider6, 0.65000000000000002, 0.0, 1.0, 0.01, 0);
	reg.registerFloatVar("mbclip.Drive4","","S",N_("Amount of distortion"),&fHslider5, 0.33000000000000002, 0.0, 1.0, 0.01, 0);
	reg.registerFloatVar("mbclip.Drive5","","S",N_("Amount of distortion"),&fHslider0, 0.10000000000000001, 0.0, 1.0, 0.01, 0);
	reg.registerFloatVar("mbclip.Gain","","S","",&fVslider0, 0.0, -40.0, 4.0, 0.10000000000000001, 0);
	reg.registerFloatVar("mbclip.crossover_b1_b2",N_("Crossover B1-B2 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider4, 80.0, 20.0, 20000.0, 1.0800000000000001, 0);
	reg.registerFloatVar("mbclip.crossover_b2_b3",N_("Crossover B2-B3 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider3, 210.0, 20.0, 20000.0, 1.0800000000000001, 0);
	reg.registerFloatVar("mbclip.crossover_b3_b4",N_("Crossover B3-B4 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider2, 1700.0, 20.0, 20000.0, 1.0800000000000001, 0);
	reg.registerFloatVar("mbclip.crossover_b4_b5",N_("Crossover B4-B5 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider1, 5000.0, 20.0, 20000.0, 1.0800000000000001, 0);
	reg.registerFloatVar("mbclip.v1","","SOLN","",&fVbargraph4, 0, -70.0, 5.0, 0, 0);
	reg.registerFloatVar("mbclip.v2","","SOLN","",&fVbargraph3, 0, -70.0, 5.0, 0, 0);
	reg.registerFloatVar("mbclip.v3","","SOLN","",&fVbargraph2, 0, -70.0, 5.0, 0, 0);
	reg.registerFloatVar("mbclip.v4","","SOLN","",&fVbargraph1, 0, -70.0, 5.0, 0, 0);
	reg.registerFloatVar("mbclip.v5","","SOLN","",&fVbargraph0, 0, -70.0, 5.0, 0, 0);
	return 0;
}
