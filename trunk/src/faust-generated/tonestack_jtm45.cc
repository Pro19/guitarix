...
#define fVslider2 (*fVslider2_)
	...
	double fSlow2 = ((0.00055000000000000003 * fSlow0) + (0.022270000000000002 * fSlow1));
	double fSlow3 = (fConst0 * (fSlow2 + 0.00207625));
	double fSlow4 = (3.0621250000000006e-07 * fSlow0);
	double fSlow5 = ((((((1.2248500000000003e-05 * fSlow1) + -5.5962500000000049e-08) - fSlow4) * fSlow0) + (1.7849040000000001e-05 * fSlow1)) + 5.4423600000000016e-07);
	double fSlow6 = ((9.2456100000000038e-10 * fSlow1) - (2.3114025000000008e-11 * fSlow0));
	double fSlow7 = (1.0781100000000005e-09 * fSlow1);
	double fSlow8 = ((((fSlow6 + -3.8387250000000005e-12) * fSlow0) + fSlow7) + 2.6952750000000009e-11);
	double fSlow9 = (fConst0 * fSlow8);
	double fSlow10 = (1.0 / (-1.0 - (fSlow3 + (fConst1 * (fSlow5 + fSlow9)))));
	double fSlow11 = double(fVslider2);
	double fSlow12 = (fConst0 * ((fSlow2 + (6.7500000000000001e-05 * fSlow11)) + 0.00055675000000000006));
	double fSlow13 = (((9.8010000000000015e-08 * fSlow11) + (((3.4333750000000009e-07 - fSlow4) * fSlow0) + (fSlow1 * ((1.2248500000000003e-05 * fSlow0) + 1.8770400000000002e-06)))) + 4.6925999999999999e-08);
	double fSlow14 = (((fSlow6 + 2.3114025000000008e-11) * fSlow0) + ((fSlow7 - (2.6952750000000009e-11 * (fSlow0 + -1.0))) * fSlow11));
