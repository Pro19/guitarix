...
inline void Dsp::clear_state_f()
{
	...
	for (int l50 = 0; (l50 < 2); l50 = (l50 + 1)) fRec62[l50] = 0.0;
	for (int l51 = 0; (l51 < 3); l51 = (l51 + 1)) fRec61[l51] = 0.0;
	for (int l52 = 0; (l52 < 3); l52 = (l52 + 1)) fRec60[l52] = 0.0;
	for (int l53 = 0; (l53 < 3); l53 = (l53 + 1)) fRec59[l53] = 0.0;
	for (int l54 = 0; (l54 < 2); l54 = (l54 + 1)) fRec66[l54] = 0.0;
	for (int l55 = 0; (l55 < 3); l55 = (l55 + 1)) fRec65[l55] = 0.0;
	for (int l56 = 0; (l56 < 2); l56 = (l56 + 1)) fVec5[l56] = 0.0;
	for (int l57 = 0; (l57 < 2); l57 = (l57 + 1)) fRec64[l57] = 0.0;
	for (int l58 = 0; (l58 < 3); l58 = (l58 + 1)) fRec63[l58] = 0.0;
	for (int l59 = 0; (l59 < 2); l59 = (l59 + 1)) fRec68[l59] = 0.0;
	for (int l60 = 0; (l60 < 3); l60 = (l60 + 1)) fRec67[l60] = 0.0;
	for (int l61 = 0; (l61 < 2); l61 = (l61 + 1)) fVec6[l61] = 0.0;
	for (int l62 = 0; (l62 < 2); l62 = (l62 + 1)) fRec13[l62] = 0.0;
	for (int l63 = 0; (l63 < 2); l63 = (l63 + 1)) fVec7[l63] = 0.0;
	for (int l64 = 0; (l64 < 2); l64 = (l64 + 1)) fRec12[l64] = 0.0;
	for (int l65 = 0; (l65 < 2); l65 = (l65 + 1)) fRec69[l65] = 0.0;
	for (int l66 = 0; (l66 < 2); l66 = (l66 + 1)) fVec8[l66] = 0.0;
	for (int l67 = 0; (l67 < 2); l67 = (l67 + 1)) fRec11[l67] = 0.0;
	for (int l68 = 0; (l68 < 3); l68 = (l68 + 1)) fRec10[l68] = 0.0;
	for (int l69 = 0; (l69 < 2); l69 = (l69 + 1)) fRec70[l69] = 0.0;
	for (int l70 = 0; (l70 < 3); l70 = (l70 + 1)) fRec9[l70] = 0.0;
	...
	for (int l75 = 0; (l75 < 2); l75 = (l75 + 1)) fRec6[l75] = 0.0;
	for (int l76 = 0; (l76 < 2); l76 = (l76 + 1)) fRec4[l76] = 0.0;
	for (int l77 = 0; (l77 < 2); l77 = (l77 + 1)) fRec2[l77] = 0.0;
	for (int l78 = 0; (l78 < 2); l78 = (l78 + 1)) fRec0[l78] = 0.0;
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec27[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec28[0] + fRec28[2])) + (fRec30[0] + (1.8508996845035413 * fRec28[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		fRec26[0] = ((0.050000000000000003 * ((fConst4 * fRec27[0]) + (fConst27 * fRec27[1]))) - (fConst28 * fRec26[1]));
		...
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec39[0] + fRec39[2])) + (fRec41[0] + (1.8508996845035413 * fRec39[1]))) + -1.271609)))) + -45.226066666666668);
		fRec37[0] = ((0.050000000000000003 * ((fConst4 * fRec38[0]) + (fConst27 * fRec38[1]))) - (fConst28 * fRec37[1]));
		...
		fRec43[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec44[0] + fRec44[2])) + (fRec51[0] + (1.8508996845035413 * fRec44[1]))) + -1.8639460000000001)))) + -60.964962962962957);
		fRec42[0] = ((0.050000000000000003 * ((fConst4 * fRec43[0]) + (fConst27 * fRec43[1]))) - (fConst28 * fRec42[1]));
		...
		fRec32[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec33[0] + fRec33[2])) + (fRec52[0] + (1.8508996845035413 * fRec33[1]))) + -1.271609)))) + -45.226066666666668);
		fRec31[0] = ((0.050000000000000003 * ((fConst4 * fRec32[0]) + (fConst27 * fRec32[1]))) - (fConst28 * fRec31[1]));
		...
		fRec22[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec23[0] + fRec23[2])) + (fRec53[0] + (1.8508996845035413 * fRec23[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		fRec21[0] = ((0.050000000000000003 * ((fConst4 * fRec22[0]) + (fConst27 * fRec22[1]))) - (fConst28 * fRec21[1]));
		fRec54[0] = (fSlow1 + (0.999 * fRec54[1]));
		...
		fRec58[0] = (fSlow2 + (0.999 * fRec58[1]));
		double fTemp15 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec14[2] + (fConst64 * (fTemp14 + (fConst66 * fRec14[0])))) * std::pow(10.0, (1.2 * fRec58[0])))));
		fRec62[0] = ((fConst70 * fRec19[1]) - (fConst19 * ((fConst20 * fRec62[1]) - (fConst14 * fRec19[0]))));
		fRec61[0] = (fRec62[0] - (fConst15 * ((fConst51 * fRec61[2]) + (fConst54 * fRec61[1]))));
		double fTemp16 = (fConst59 * fRec60[1]);
		fRec60[0] = ((fConst15 * (((fConst53 * fRec61[0]) + (fConst71 * fRec61[1])) + (fConst53 * fRec61[2]))) - (fConst72 * ((fConst73 * fRec60[2]) + fTemp16)));
		double fTemp17 = (fConst69 * fRec59[1]);
		fRec59[0] = ((fRec60[2] + (fConst72 * (fTemp16 + (fConst73 * fRec60[0])))) - (fConst64 * ((fConst66 * fRec59[2]) + fTemp17)));
		double fTemp18 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec59[2] + (fConst64 * (fTemp17 + (fConst66 * fRec59[0])))) * std::pow(10.0, (0.80000000000000004 * fRec58[0])))));
		fRec66[0] = (0.0 - (fConst76 * ((fConst56 * fRec66[1]) - (fConst15 * (fTemp13 + fVec4[1])))));
		fRec65[0] = (fRec66[0] - (fConst10 * ((fConst58 * fRec65[2]) + (fConst59 * fRec65[1]))));
		double fTemp19 = (fRec65[2] + (fRec65[0] + (2.0 * fRec65[1])));
		fVec5[0] = fTemp19;
		fRec64[0] = ((fConst10 * ((fConst75 * fTemp19) + (fConst77 * fVec5[1]))) - (fConst78 * fRec64[1]));
		fRec63[0] = (fRec64[0] - (fConst74 * ((fConst79 * fRec63[2]) + (fConst69 * fRec63[1]))));
		double fTemp20 = std::max<double>(-1.0, std::min<double>(1.0, (fConst74 * ((((fConst68 * fRec63[0]) + (fConst80 * fRec63[1])) + (fConst68 * fRec63[2])) * std::pow(10.0, (2.0 * fRec58[0]))))));
		fRec68[0] = (0.0 - (fConst81 * ((fConst65 * fRec68[1]) - (fConst10 * (fTemp19 + fVec5[1])))));
		fRec67[0] = (fRec68[0] - (fConst74 * ((fConst79 * fRec67[2]) + (fConst69 * fRec67[1]))));
		double fTemp21 = std::max<double>(-1.0, std::min<double>(1.0, (fConst74 * ((fRec67[2] + (fRec67[0] + (2.0 * fRec67[1]))) * std::pow(10.0, (0.90000000000000002 * fRec58[0]))))));
		...
		double fTemp23 = (2.0 * (fRec58[0] + -0.5));
		double fTemp24 = (fRec21[0] * (1.0 - fRec54[0]));
		double fTemp25 = ((fRec13[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp23)))) + ((fTemp24 * ((1.25 * (fRec58[0] * ((4.0 * (1.0 - std::fabs(fTemp24))) + -1.0))) + 1.0)) + (0.024937655860349125 * (fTemp11 * (1.0 - std::max<double>(0.0, fTemp23))))));
		fVec7[0] = fTemp25;
		fRec12[0] = (0.0 - (fConst6 * ((fConst7 * fRec12[1]) - (fTemp25 + fVec7[1]))));
		fRec69[0] = (fSlow3 + (0.999 * fRec69[1]));
		double fTemp26 = (fRec12[0] * fRec69[0]);
		fVec8[0] = fTemp26;
		fRec11[0] = ((0.93028479253239138 * (fTemp26 + fVec8[1])) - (0.86056958506478287 * fRec11[1]));
		fRec10[0] = (fRec11[0] - ((1.8405051250752198 * fRec10[1]) + (0.86129424393186271 * fRec10[2])));
		double fTemp27 = (0.92544984225177063 * (fRec10[0] + fRec10[2]));
		fRec70[0] = (fConst6 * ((0.0041000000000000003 * (fRec9[1] + fRec9[2])) - (fConst7 * fRec70[1])));
		double fTemp28 = (1.8508996845035413 * fRec10[1]);
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp27 + (fRec70[0] + fTemp28)) + -0.65976100000000004)))) + -89.08268292682925);
		fRec8[0] = ((0.025000000000000001 * ((fConst4 * fRec9[0]) + (fConst27 * fRec9[1]))) - (fConst28 * fRec8[1]));
		fRec73[0] = (fConst6 * ((0.0041000000000000003 * (fRec72[1] + fRec72[2])) - (fConst7 * fRec73[1])));
		fRec72[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp27 + (fRec73[0] + fTemp28)) + -0.66454100000000005)))) + -87.916829268292673);
		fRec71[0] = ((0.025000000000000001 * ((fConst4 * fRec72[0]) + (fConst27 * fRec72[1]))) - (fConst28 * fRec71[1]));
		double fTemp29 = (std::min<double>(0.69999999999999996, fRec8[0]) + std::max<double>(-0.75, fRec71[0]));
		...
		double fTemp33 = ((fTemp29 + (0.20000000000000001 * fRec6[1])) - fTemp32);
		fRec6[0] = fTemp33;
		double fRec7 = (0.0 - (0.20000000000000001 * fTemp33));
		fRec4[0] = (fRec7 + fRec6[1]);
		double fRec5 = (0.29999999999999999 * (fTemp29 - fTemp32));
		fRec2[0] = (fRec5 + fRec4[1]);
		double fRec3 = (0.40000000000000002 * (fTemp29 - (fTemp31 + fTemp30)));
		fRec0[0] = (fRec3 + fRec2[1]);
		double fRec1 = (0.5 * (fTemp29 - fTemp30));
