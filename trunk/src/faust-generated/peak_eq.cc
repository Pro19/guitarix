...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	double fSlow16 = (fConst1 * ((fSlow14 * std::pow(10.0, (0.050000000000000003 * std::fabs(fSlow12)))) / fSlow15));
	double fSlow17 = (fConst1 * (fSlow14 / fSlow15));
	double fSlow18 = (iSlow13?fSlow17:fSlow16);
	double fSlow19 = (1.0 - (fSlow11 * (fSlow18 - fSlow11)));
	double fSlow20 = (2.0 * (1.0 - (1.0 / mydsp_faustpower2_f(fSlow10))));
	double fSlow21 = ((fSlow11 * (fSlow11 + fSlow18)) + 1.0);
	double fSlow22 = (iSlow13?fSlow16:fSlow17);
	double fSlow23 = ((fSlow11 * (fSlow11 + fSlow22)) + 1.0);
	double fSlow24 = (1.0 - (fSlow11 * (fSlow22 - fSlow11)));
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		double fTemp0 = (fSlow20 * fRec3[1]);
		fRec3[0] = (double(input0[i]) - (((fRec3[2] * fSlow19) + fTemp0) / fSlow21));
		double fTemp1 = (fSlow8 * fRec2[1]);
		fRec2[0] = (((((fRec3[0] * fSlow23) + fTemp0) + (fSlow24 * fRec3[2])) / fSlow21) - (((fRec2[2] * fSlow33) + fTemp1) / fSlow34));
