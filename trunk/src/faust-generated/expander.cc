...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerFloatVar("expander.knee","","S","",&fEntry2, 3.0, 0.0, 20.0, 0.10000000000000001, 0);
	...
	reg.registerFloatVar("expander.threshold","","S","",&fEntry1, -40.0, -96.0, 10.0, 0.10000000000000001, 0);
