...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec13[0] + fRec13[2])) + (fRec35[0] + (1.8508996845035413 * fRec13[1]))) + -3.7189619999999999)))) + -112.26066666666668);
		fRec11[0] = ((0.025000000000000001 * ((fConst4 * fRec12[0]) + (fConst26 * fRec12[1]))) - (fConst27 * fRec11[1]));
		double fTemp15 = (fRec11[0] * fRec5[0]);
		fVec5[0] = fTemp15;
		fRec10[0] = (fConst6 * ((2.0 * (fTemp15 + fVec5[1])) - (fConst7 * fRec10[1])));
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec8[0] + fRec8[2])) + (fRec36[0] + (1.8508996845035413 * fRec8[1]))) + -2.3148439999999999)))) + -95.677066666666661);
		fRec6[0] = ((0.025000000000000001 * ((fConst4 * fRec7[0]) + (fConst26 * fRec7[1]))) - (fConst27 * fRec6[1]));
		double fTemp16 = (fRec5[0] * fRec6[0]);
		fVec6[0] = fTemp16;
		fRec4[0] = (fConst6 * ((2.0 * (fTemp16 + fVec6[1])) - (fConst7 * fRec4[1])));
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec2[0] + fRec2[2])) + (fRec37[0] + (1.8508996845035413 * fRec2[1]))) + -1.3565670000000001)))) + -84.564999999999998);
		fRec0[0] = ((0.025000000000000001 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		fRec38[0] = (fSlow3 + (0.999 * fRec38[1]));
		buf[i] = FAUSTFLOAT((2.0 * (fRec0[0] * fRec38[0])));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
