...
inline void Dsp::clear_state_f()
{
	...
	for (int l47 = 0; (l47 < 2); l47 = (l47 + 1)) fRec38[l47] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec13[0] + fRec13[2])) + (fRec35[0] + (1.8508996845035413 * fRec13[1]))) + -1.8639460000000001)))) + -60.964962962962957);
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec8[0] + fRec8[2])) + (fRec36[0] + (1.8508996845035413 * fRec8[1]))) + -1.271609)))) + -45.226066666666668);
		...
		double fTemp17 = (0.92544984225177063 * (fRec2[0] + fRec2[2]));
		fRec37[0] = (fConst66 * ((0.0082000000000000007 * (fRec1[1] + fRec1[2])) - (fConst67 * fRec37[1])));
		double fTemp18 = (1.8508996845035413 * fRec2[1]);
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp17 + (fRec37[0] + fTemp18)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec0[0] = ((0.050000000000000003 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		fRec40[0] = (fConst66 * ((0.0082000000000000007 * (fRec39[1] + fRec39[2])) - (fConst67 * fRec40[1])));
		fRec39[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp17 + (fRec40[0] + fTemp18)) + -0.79704299999999995)))) + -32.799634146341475);
		fRec38[0] = ((0.050000000000000003 * ((fConst4 * fRec39[0]) + (fConst26 * fRec39[1]))) - (fConst27 * fRec38[1]));
		fRec41[0] = (fSlow3 + (0.999 * fRec41[1]));
		buf[i] = FAUSTFLOAT(((fRec0[0] + fRec38[0]) * fRec41[0]));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
