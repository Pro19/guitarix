...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec24[0] + fRec24[2])) + (fRec49[0] + (1.8508996845035413 * fRec24[1]))) + -1.2572399999999999)))) + -83.435555555555567);
