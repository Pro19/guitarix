...
{
	fVslider0_ = reg.registerFloatVar("pre_st.Level",N_("Level"),"SA",N_("Level"),&fVslider0, 1.0, 0.10000000000000001, 2.1000000000000001, 0.10000000000000001, 0);
	fVslider2_ = reg.registerFloatVar("pre_st.bass",N_("Bass"),"SA",N_("Bass"),&fVslider2, 0.0, -10.0, 10.0, 0.5, 0);
	fVslider1_ = reg.registerFloatVar("pre_st.treble",N_("Treble"),"SA",N_("Treble"),&fVslider1, 0.0, -10.0, 10.0, 0.5, 0);
	return 0;
}
