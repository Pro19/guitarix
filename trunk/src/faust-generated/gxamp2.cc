...
inline void Dsp::clear_state_f()
{
	...
	for (int l12 = 0; (l12 < 2); l12 = (l12 + 1)) fRec29[l12] = 0.0;
	for (int l13 = 0; (l13 < 3); l13 = (l13 + 1)) fRec28[l13] = 0.0;
	for (int l14 = 0; (l14 < 3); l14 = (l14 + 1)) fRec27[l14] = 0.0;
	for (int l15 = 0; (l15 < 3); l15 = (l15 + 1)) fRec26[l15] = 0.0;
	for (int l16 = 0; (l16 < 2); l16 = (l16 + 1)) fRec33[l16] = 0.0;
	...
	for (int l22 = 0; (l22 < 3); l22 = (l22 + 1)) fRec34[l22] = 0.0;
	...
	for (int l29 = 0; (l29 < 3); l29 = (l29 + 1)) fRec13[l29] = 0.0;
	...
	for (int l38 = 0; (l38 < 2); l38 = (l38 + 1)) fRec5[l38] = 0.0;
	for (int l39 = 0; (l39 < 2); l39 = (l39 + 1)) fRec38[l39] = 0.0;
	for (int l40 = 0; (l40 < 3); l40 = (l40 + 1)) fRec4[l40] = 0.0;
	for (int l41 = 0; (l41 < 2); l41 = (l41 + 1)) fVec6[l41] = 0.0;
	...
	for (int l45 = 0; (l45 < 3); l45 = (l45 + 1)) fRec1[l45] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec24[0] = (fSlow1 + (0.999 * fRec24[1]));
		double fTemp0 = double(buf[i]);
		fRec23[0] = ((fRec24[0] * fTemp0) - (fConst23 * ((fConst24 * fRec23[2]) + (fConst25 * fRec23[1]))));
		double fTemp1 = (fRec23[2] + (fRec23[0] + (2.0 * fRec23[1])));
		fVec0[0] = fTemp1;
		fRec22[0] = ((fConst23 * ((fConst4 * fTemp1) + (fConst26 * fVec0[1]))) - (fConst27 * fRec22[1]));
		...
		fVec1[0] = fTemp2;
		fRec19[0] = ((fConst15 * ((fConst17 * fTemp2) + (fConst32 * fVec1[1]))) - (fConst34 * fRec19[1]));
		fRec18[0] = (fRec19[0] - (fConst10 * ((fConst35 * fRec18[2]) + (fConst36 * fRec18[1]))));
		double fTemp3 = (fConst46 * fRec17[1]);
		fRec17[0] = ((fConst10 * (((fConst12 * fRec18[0]) + (fConst37 * fRec18[1])) + (fConst12 * fRec18[2]))) - (fConst41 * ((fConst43 * fRec17[2]) + fTemp3)));
		fRec25[0] = (fSlow2 + (0.999 * fRec25[1]));
		double fTemp4 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec17[2] + (fConst41 * (fTemp3 + (fConst43 * fRec17[0])))) * std::pow(10.0, (1.2 * fRec25[0])))));
		fRec29[0] = ((fConst47 * fRec22[1]) - (fConst19 * ((fConst20 * fRec29[1]) - (fConst14 * fRec22[0]))));
		fRec28[0] = (fRec29[0] - (fConst15 * ((fConst28 * fRec28[2]) + (fConst31 * fRec28[1]))));
		double fTemp5 = (fConst36 * fRec27[1]);
		fRec27[0] = ((fConst15 * (((fConst30 * fRec28[0]) + (fConst48 * fRec28[1])) + (fConst30 * fRec28[2]))) - (fConst49 * ((fConst50 * fRec27[2]) + fTemp5)));
		double fTemp6 = (fConst46 * fRec26[1]);
		fRec26[0] = ((fRec27[2] + (fConst49 * (fTemp5 + (fConst50 * fRec27[0])))) - (fConst41 * ((fConst43 * fRec26[2]) + fTemp6)));
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec26[2] + (fConst41 * (fTemp6 + (fConst43 * fRec26[0])))) * std::pow(10.0, (0.80000000000000004 * fRec25[0])))));
		fRec33[0] = (0.0 - (fConst53 * ((fConst33 * fRec33[1]) - (fConst15 * (fTemp2 + fVec1[1])))));
		fRec32[0] = (fRec33[0] - (fConst10 * ((fConst35 * fRec32[2]) + (fConst36 * fRec32[1]))));
		double fTemp8 = (fRec32[2] + (fRec32[0] + (2.0 * fRec32[1])));
		fVec2[0] = fTemp8;
		fRec31[0] = ((fConst10 * ((fConst52 * fTemp8) + (fConst54 * fVec2[1]))) - (fConst55 * fRec31[1]));
		fRec30[0] = (fRec31[0] - (fConst51 * ((fConst56 * fRec30[2]) + (fConst46 * fRec30[1]))));
		double fTemp9 = std::max<double>(-1.0, std::min<double>(1.0, (fConst51 * ((((fConst45 * fRec30[0]) + (fConst57 * fRec30[1])) + (fConst45 * fRec30[2])) * std::pow(10.0, (2.0 * fRec25[0]))))));
		fRec35[0] = (0.0 - (fConst58 * ((fConst42 * fRec35[1]) - (fConst10 * (fTemp8 + fVec2[1])))));
		fRec34[0] = (fRec35[0] - (fConst51 * ((fConst56 * fRec34[2]) + (fConst46 * fRec34[1]))));
		double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fConst51 * ((fRec34[2] + (fRec34[0] + (2.0 * fRec34[1]))) * std::pow(10.0, (0.90000000000000002 * fRec25[0]))))));
		...
		fVec3[0] = fTemp11;
		fRec16[0] = (0.0 - (fConst6 * ((fConst7 * fRec16[1]) - (fTemp11 + fVec3[1]))));
		double fTemp12 = (2.0 * (fRec25[0] + -0.5));
		double fTemp13 = (1.0 - fRec24[0]);
		double fTemp14 = (fRec10[0] * ((fRec16[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp12)))) + (((fTemp13 * ((1.25 * (fRec25[0] * ((4.0 * (1.0 - std::fabs((fTemp13 * fTemp0)))) + -1.0))) + 1.0)) + (fRec24[0] * (1.0 - std::max<double>(0.0, fTemp12)))) * fTemp0)));
		fVec4[0] = fTemp14;
		fRec15[0] = ((0.93028479253239138 * (fTemp14 + fVec4[1])) - (0.86056958506478287 * fRec15[1]));
		fRec14[0] = (fRec15[0] - ((1.8405051250752198 * fRec14[1]) + (0.86129424393186271 * fRec14[2])));
		fRec36[0] = (fConst60 * ((0.027 * (fRec13[1] + fRec13[2])) - (fConst61 * fRec36[1])));
		fRec13[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double((((0.92544984225177063 * (fRec14[0] + fRec14[2])) + (fRec36[0] + (1.8508996845035413 * fRec14[1]))) + -2.2961499999999999)))) + -164.9574074074074);
		...
		double fTemp15 = (fRec10[0] * fRec11[0]);
		fVec5[0] = fTemp15;
		fRec9[0] = ((0.93028479253239138 * (fTemp15 + fVec5[1])) - (0.86056958506478287 * fRec9[1]));
		fRec8[0] = (fRec9[0] - ((1.8405051250752198 * fRec8[1]) + (0.86129424393186271 * fRec8[2])));
		fRec37[0] = (fConst63 * ((0.014999999999999999 * (fRec7[1] + fRec7[2])) - (fConst64 * fRec37[1])));
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double((((0.92544984225177063 * (fRec8[0] + fRec8[2])) + (fRec37[0] + (1.8508996845035413 * fRec8[1]))) + -1.6755869999999999)))) + -138.29419999999999);
		...
		fRec4[0] = ((fRec5[0] * fRec38[0]) - ((fConst66 * fRec4[1]) + (0.85026841000000009 * fRec4[2])));
		double fTemp16 = (fRec4[0] - (1.0589999999999999 * fRec4[1]));
		fVec6[0] = fTemp16;
		fRec3[0] = ((0.93028479253239138 * (fTemp16 + fVec6[1])) - (0.86056958506478287 * fRec3[1]));
		fRec2[0] = (fRec3[0] - ((1.8405051250752198 * fRec2[1]) + (0.86129424393186271 * fRec2[2])));
		fRec39[0] = (fConst68 * ((0.0082000000000000007 * (fRec1[1] + fRec1[2])) - (fConst69 * fRec39[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double((((0.92544984225177063 * (fRec2[0] + fRec2[2])) + (fRec39[0] + (1.8508996845035413 * fRec2[1]))) + -1.1304620000000001)))) + -112.13878048780487);
