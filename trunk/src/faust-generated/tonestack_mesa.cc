...
#define fVslider2 (*fVslider2_)
	...
	double fSlow2 = ((0.001175 * fSlow0) + (0.025062500000000001 * fSlow1));
	double fSlow3 = (fConst0 * (fSlow2 + 0.017268749999999999));
	double fSlow4 = (2.9448437500000003e-06 * fSlow0);
	double fSlow5 = ((((((2.9448437500000007e-05 * fSlow1) + -8.7317187500000011e-06) - fSlow4) * fSlow0) + (0.00011998125000000002 * fSlow1)) + 1.2916875000000002e-05);
	double fSlow6 = ((2.5703125000000004e-09 * fSlow1) - (2.5703125000000003e-10 * fSlow0));
	double fSlow7 = (7.3437500000000008e-09 * fSlow1);
	double fSlow8 = ((((fSlow6 + -4.7734375000000009e-10) * fSlow0) + fSlow7) + 7.3437500000000006e-10);
	...
	double fSlow13 = (((9.187500000000001e-07 * fSlow11) + (((3.0182812500000004e-06 - fSlow4) * fSlow0) + (fSlow1 * ((2.9448437500000007e-05 * fSlow0) + 2.4812500000000002e-06)))) + 2.4812500000000001e-07);
	double fSlow14 = (((fSlow6 + 2.5703125000000003e-10) * fSlow0) + ((fSlow7 - (7.3437500000000006e-10 * (fSlow0 + -1.0))) * fSlow11));
